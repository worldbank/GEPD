  ...
  if (dataset=='school') {
    ...
    if (tag == "LERN_micro") {
      stat_df <- stat_df %>%
        ...
        select(VALUE, strata, school_weight, g4_stud_weight_component, hashed_school_code, student_number) %>%
        pivot_longer(
          cols = "VALUE",
          names_to = "indicators",
          values_to = "value"
        ...
        as_survey_design(
          id = c(hashed_school_code, student_number),
          strata = strata,
    ...
    if (tag == "EFFT_micro") {
      stat_df <- stat_df %>%
        ...
        mutate(strata = factor(strata_count)) %>%
        as_survey_design(
          id = c(hashed_school_code, questionnaire_selected__id),
          strata = strata,
...
api_template <- api_template %>%
  ...
  for (i in c("mean", "mean_se", "mean_low", "mean_upp", "mean_var")) {
    ...
    assign(paste0("indicator_values_transpose_", i),
           get(paste0("indicator_values_transpose_", i)) %>%    
             mutate(
              SE.PRM.PEDG     = 100*indicator_means(teach_score>=3, "school", "PEDG",  "All", i),
              SE.PRM.PEDG.1   = 100*indicator_means(teach_score>=3, "school", "PEDG",  "All", i),
              ...
              SE.PRM.PEDG.1.R = 100*indicator_means(teach_score>=3, "school", "PEDG",  "Rural", i),
              SE.PRM.PEDG.1.U = 100*indicator_means(teach_score>=3, "school", "PEDG",  "Urban", i),
              SE.PRM.PEDG.2   = 100*indicator_means(classroom_culture>=3, "school", "PEDG",  "All", i),  
              ...
              SE.PRM.PEDG.2.R = 100*indicator_means(classroom_culture>=3, "school", "PEDG",  "Rural", i),
              SE.PRM.PEDG.2.U = 100*indicator_means(classroom_culture>=3, "school", "PEDG",  "Urban", i),
              SE.PRM.PEDG.3   = 100*indicator_means(instruction>=3, "school", "PEDG",  "All", i),
              ...
              SE.PRM.PEDG.3.R = 100*indicator_means(instruction>=3, "school", "PEDG",  "Rural", i),
              SE.PRM.PEDG.3.U = 100*indicator_means(instruction>=3, "school", "PEDG",  "Urban", i),
              SE.PRM.PEDG.4   = 100*indicator_means(socio_emotional_skills>=3, "school", "PEDG",  "All", i),
              ...
              SE.PRM.PEDG.4.R = 100*indicator_means(socio_emotional_skills>=3, "school", "PEDG",  "Rural", i),
              SE.PRM.PEDG.4.U = indicator_means(socio_emotional_skills>=3, "school", "PEDG",  "Urban", i)
             )
    )
  }
  ...
  for (i in c("N")) {
    ...
    assign(paste0("indicator_values_transpose_", i),
           get(paste0("indicator_values_transpose_", i)) %>%    
             mutate(
               SE.PRM.PEDG     = indicator_means(teach_score>=3, "school", "PEDG",  "All", i),
               SE.PRM.PEDG.1   = indicator_means(teach_score>=3, "school", "PEDG",  "All", i),
               #SE.PRM.PEDG.1.F = 100*indicator_means(teach_score>=3, "school", "PEDG",  "Female"),
               #SE.PRM.PEDG.1.M = 100*indicator_means(teach_score>=3, "school", "PEDG",  "Male"),
               SE.PRM.PEDG.1.R = indicator_means(teach_score>=3, "school", "PEDG",  "Rural", i),
               SE.PRM.PEDG.1.U = indicator_means(teach_score>=3, "school", "PEDG",  "Urban", i),
               SE.PRM.PEDG.2   = indicator_means(classroom_culture>=3, "school", "PEDG",  "All", i),  
               #SE.PRM.PEDG.2.F = 100*indicator_means(classroom_culture>=3, "school", "PEDG",  "Female"),
               #SE.PRM.PEDG.2.M = 100*indicator_means(classroom_culture>=3, "school", "PEDG",  "Male"),
               SE.PRM.PEDG.2.R = indicator_means(classroom_culture>=3, "school", "PEDG",  "Rural", i),
               SE.PRM.PEDG.2.U = indicator_means(classroom_culture>=3, "school", "PEDG",  "Urban", i),
               SE.PRM.PEDG.3   = indicator_means(instruction>=3, "school", "PEDG",  "All", i),
               #SE.PRM.PEDG.3.F = 100*indicator_means(instruction>=3, "school", "PEDG",  "Female"),
               #SE.PRM.PEDG.3.M = 100*indicator_means(instruction>=3, "school", "PEDG",  "Male"),
               SE.PRM.PEDG.3.R = indicator_means(instruction>=3, "school", "PEDG",  "Rural", i),
               SE.PRM.PEDG.3.U = indicator_means(instruction>=3, "school", "PEDG",  "Urban", i),
               SE.PRM.PEDG.4   = indicator_means(socio_emotional_skills>=3, "school", "PEDG",  "All", i),
               #SE.PRM.PEDG.4.F = 100*indicator_means(socio_emotional_skills>=3, "school", "PEDG",  "Female"),
               #SE.PRM.PEDG.4.M = 100*indicator_means(socio_emotional_skills>=3, "school", "PEDG",  "Male"),
               SE.PRM.PEDG.4.R = indicator_means(socio_emotional_skills>=3, "school", "PEDG",  "Rural", i),
               SE.PRM.PEDG.4.U = indicator_means(socio_emotional_skills>=3, "school", "PEDG",  "Urban", i)
             )
    )
  }
    ...
    assign(paste0("indicator_values_transpose_", i),
           get(paste0("indicator_values_transpose_", i)) %>%    
             mutate(
              ...
              SE.PRM.TATT.DJ = indicator_means(teacher_attraction		, "school", "TATT_micro",  "All", i)
             )
    )
  }
    ...
    assign(paste0("indicator_values_transpose_", i),
           get(paste0("indicator_values_transpose_", i)) %>%    
             mutate(
              ...
              #(De Jure) Practicum is NOT required as part of pre-service training                                                             
    ...
    assign(paste0("indicator_values_transpose_", i),
           get(paste0("indicator_values_transpose_", i)) %>%    
             mutate(
              ...
              SE.PRM.TEVL.5 = indicator_means(number_criteria_indicator		, "school", "TEVL_micro",  "All", i),  #(De Facto) Number of criteria used to evaluate teachers                                                                  
    ...
    assign(paste0("indicator_values_transpose_", i),
           get(paste0("indicator_values_transpose_", i)) %>%    
             mutate(
               ...
               SE.PRM.LNTN.8  =NA #(De Facto) Percent of schools reporting having publicly funded school feeding program
             ) %>%
             mutate(
    ...
    assign(paste0("indicator_values_transpose_", i),
           get(paste0("indicator_values_transpose_", i)) %>%    
             mutate(
              ...
              SE.PRM.BIMP.4=  indicator_means(pol_policy_implementation		, "public_officials", "BIMP",  "All", i), #(Impartial Decision-Making) average score for politicized policy implementation                                            
  ...
  new_cols <- c(
    "SE.PRM.BFIN.6", "SE.PRM.SSLD.DJ", "SE.PRM.PROE", "SE.PRM.PROE.1", "SE.PRM.BFIN.6"
  )
