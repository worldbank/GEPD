...
api_template <- api_template %>%
  ...
  indicator_values_transpose <- indicator_values_transpose %>%
    mutate(
      ...
      SE.PRM.LERN.1.F = indicator_means(student_proficient, "school", "LERN_micro",  "Female"),
  ...
  indicator_values_transpose <- indicator_values_transpose %>%
    mutate(
      ...
      SE.PRM.TATT.5 = 100*indicator_means(if_else((teacher_bonus_hard_staff==1 | teacher_bonus_subj_shortages==1),1,0	)	, "school", "TATT_micro",  "All"),
      ...
      SE.PRM.TATT.DF = expert_df$teacher_attraction,
      #(De Jure) Policy Lever (Teaching) - Attraction	
      SE.PRM.TATT.DJ = indicator_means(teacher_attraction		, "school", "TATT_micro",  "All")
  ...
  SE.PRM.SATT.2 = indicator_means(100*principal_salary		, "school", "SATT",  "All"),  #(De Facto) Average principal salary as percent of GDP per capita                                                          
  ...
  SE.PRM.BIMP.4=  indicator_means(pol_policy_implementation		, "public_officials", "BIMP",  "All"), #(Impartial Decision-Making) average score for politicized policy implementation
