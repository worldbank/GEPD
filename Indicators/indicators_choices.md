...
|SE.PRM.OPMN |Operational Management|0-5 | School Survey.  Princials/head teachers are given two vignettes: <br> - One on solving the problem of a hypothetical leaky roof <br> - One on solving a problem of inadequate numbers of textbooks.  <br> Each vignette is worth 2 points.  <br> <br> The indicator will measure two things: presence of functions and quality of functions. In each vignette: <br> - 0.5 points are awarded for someone specific having the responsibility to fix <br> - 0.5 point is awarded if the school can fully fund the repair, 0.25 points is awarded if the school must get partial help from the community, and 0 points are awarded if the full cost must be born by the community <br> - 1 point is awarded if the problem is fully resolved in a timely manner, with partial credit given if problem can only be partly resolved.  |
...
|SE.PRM.PMAN |Principal Management Skills|1-5 | |
