...
wbopendat<-WDI(country='SL', indicator=ind_list, start=2000, end=2021, extra=T) %>%
  ...
  mutate(
    ...
    SE.LPV.PRIM=(100-SE.LPV.PRIM.BMP)*SE.PRM.TENR/100,
    SE.LPV.PRIM.FE=(100-SE.LPV.PRIM.BMP.FE)*SE.PRM.TENR.FE/100,
    SE.LPV.PRIM.MA=(100-SE.LPV.PRIM.BMP.MA)*SE.PRM.TENR.MA/100
  )
