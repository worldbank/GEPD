...
if (str_to_lower(Sys.info()["user"]) == "wb469649") {
  ...
  data_dir <- "C:/Users/wb631589/OneDrive - WBG/GEPD/CNT/MDG/MDG_2021_GEPD/MDG_2021_GEPD_v02_M/Data/"
  data_dir_conf <- "C:/Users/wb631589/OneDrive - WBG/GEPD-Confidential/CNT/MDG/MDG_2021_GEPD/MDG_2021_GEPD_v02_RAW/Data/anonymized"
}
...
load(paste(data_dir_conf, "School/school_indicators_data_anon.RData", sep="/"))
...
#read in data
defacto_dta_learners <- read_csv(paste(data_dir, 'Other_Indicators/Learners_defacto_indicators.csv', sep="/")) %>%
