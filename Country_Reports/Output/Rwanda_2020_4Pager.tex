...
\cellcolor{outcome}\multirow{-5}{*}{\rotatebox{90}{\textcolor{white}{Outcomes}}} &  Participation and learning  & Learning adjusted years of schooling (in years) & {\cellcolor{red!15}3.8}\\\cdashline{1-4}
\cellcolor{practice} & \multirow{3}{2cm}{Teaching}                 & Teacher Effort           & {\cellcolor{green!15}80\%} \\\cdashline{3-4}
...
\cellcolor{practice} &                                             & Student Attendance       & {\cellcolor{green!15}87\%} \\\cdashline{2-4}
...
Learning                  & Proficiency on GEPD Assessment  & {\cellcolor{red!15}0.1\%} & {\cellcolor{red!15}0.2\%} \\\cdashline{1-4}
\multirow{3}{*}{Teaching} & Teacher Effort      & {\cellcolor{yellow!15}79\%} & {\cellcolor{green!15}80\%} \\\cdashline{2-4}
...
\multirow{2}{*}{Learners}   & Capacity for Learning    & {\cellcolor{red!15}52\%} & {\cellcolor{red!15}55\%} \\\cdashline{2-4}
                            & Student Attendance       & {\cellcolor{green!15}82\%} & {\cellcolor{green!15}84\%} \\\cdashline{1-4}
...
Learning                  & Proficiency on GEPD Assessment & {\cellcolor{red!15}0.1\%} & {\cellcolor{red!15}0.8\%} \\\cdashline{1-4}
\multirow{3}{*}{Teaching} & Teacher Effort                 & {\cellcolor{yellow!15}79\%} & {\cellcolor{green!15}85\%} \\\cdashline{2-4}
...
\multirow{2}{*}{Learners}   & Capacity for Learning    & {\cellcolor{red!15}52\%} & {\cellcolor{yellow!15}63\%} \\\cdashline{2-4}
                            & Student Attendance       & {\cellcolor{green!15}86\%} & {\cellcolor{green!15}93\%} \\\cdashline{1-4}
...
\includegraphics[width=1\linewidth]{/Users/kanikaverma/Documents/GitHub/gepd/Country_Reports/LP figures/lays_figure_RWA}
...
\includegraphics{/Users/kanikaverma/Documents/GitHub/gepd/Country_Reports/Output/Rwanda_2020_4Pager_files/figure-latex/lern_teach-1.pdf}
...
Capacity for learning                  & {\cellcolor{red!15}9\%} & & \cellcolor{red!15}\\\cdashline{1-2}
\hspace{1mm}\emph{Numeracy score}        & \cellcolor{yellow!15}62   & \multirow{-2}{*}{Nutrition Programs} & \multirow{-2}{*}{\cellcolor{red!15}-2995.9}  \\\cdashline{1-4}  
\hspace{1mm}\emph{Literacy score}        & \cellcolor{red!15}38   & Health Programs                     & \cellcolor{red!15}-2663 \\\cdashline{1-4}  
\hspace{1mm}\emph{Executive score}       & \cellcolor{red!15}47   & Center based care                   & \cellcolor{red!15}-3995 \\\cdashline{1-4}  
\hspace{1mm}\emph{Socio-emotional score} & \cellcolor{yellow!15}67   & Caregiver Skills Capacity           & \cellcolor{red!15}-3995 \\\cdashline{1-4}  
Student Attendance                     & {\cellcolor{green!15}87\%}     & Caregiver Financial Capacity        & \cellcolor{red!15}-3995 \\\hline
\end{tabular}}
\\
...
\hspace{1mm}\emph{\% Classroom observed}     & {\cellcolor{green!15}88\%} & & \cellcolor{green!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Discussed observations} & {\cellcolor{red!15}51\%} & & \cellcolor{green!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Feedback given}         & {\cellcolor{yellow!15}70\%} & & \cellcolor{green!15}\\\cdashline{1-2}
...
\hspace{1mm}\emph{\% Teachers' knowledge}  & {\cellcolor{green!15}80\%} & \multirow{-2}{4cm}{Attraction} & \multirow{-2}{*}{\cellcolor{green!15}4.3}\\\cdashline{1-4}
\hspace{1mm}\emph{\% Teachers' experience} & {\cellcolor{green!15}99\%} & & \cellcolor{yellow!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Input availability}      & {\cellcolor{yellow!15}77\%} & \multirow{-2}{4cm}{Selection \& Deployment} & \multirow{-2}{*}{\cellcolor{yellow!15}3.9} \\\cdashline{1-4} 
...
\includegraphics{/Users/kanikaverma/Documents/GitHub/gepd/Country_Reports/Output/Rwanda_2020_4Pager_files/figure-latex/defacto_graphs-1.pdf}
...
\includegraphics{/Users/kanikaverma/Documents/GitHub/gepd/Country_Reports/Output/Rwanda_2020_4Pager_files/figure-latex/defacto_sub_graphs_1-1.pdf}
...
\includegraphics{/Users/kanikaverma/Documents/GitHub/gepd/Country_Reports/Output/Rwanda_2020_4Pager_files/figure-latex/defacto_sub_graphs_2-1.pdf}
...
\includegraphics{/Users/kanikaverma/Documents/GitHub/gepd/Country_Reports/Output/Rwanda_2020_4Pager_files/figure-latex/defacto_sub_graphs_3-1.pdf}
...
\includegraphics{/Users/kanikaverma/Documents/GitHub/gepd/Country_Reports/Output/Rwanda_2020_4Pager_files/figure-latex/politics_graph-1.pdf}
...
\multirow{-4}{2cm}{Quality of bureaucracy (1-5)} & Motivation and attitudes &\cellcolor{green!15}4.4 \\\hline
...
\multirow{-4}{2cm}{Impartial decision making (1-5)} & Employee unions as facilitators &\cellcolor{green!15}4.7 \\\hline
                                   & Coherence &\cellcolor{green!15}4.1 \\\cdashline{2-3}
                                   & Transparency &\cellcolor{green!15}4.5 \\\cdashline{2-3}
\multirow{-3}{2cm}{Mandates and accountability (1-5)} & Public official accountability &\cellcolor{green!15}4.8 \\\hline
