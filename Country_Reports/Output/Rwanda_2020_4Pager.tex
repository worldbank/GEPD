...
\hypertarget{table-1.-gepd-indicators-rwanda-2020}{%
\paragraph{Table 1. GEPD Indicators, Rwanda,
2020}\label{table-1.-gepd-indicators-rwanda-2020}}
...
\cellcolor{outcome} &                             & Proficiency on GEPD Assessment & {\cellcolor{red!10}0.2\%} \\\cdashline{2-4}
\cellcolor{outcome} &  Participation              & Net Adjusted Enrollment Rate   & {\%} \\\cdashline{2-4}
\cellcolor{outcome}\multirow{-5}{*}{\rotatebox{90}{\textcolor{white}{Outcomes}}} &  Participation and learning  & Learning adjusted years of schooling (in years) & {\cellcolor{red!10}3.8}\\\cdashline{1-4}
\cellcolor{practice} & \multirow{3}{2cm}{Teaching}                 & Teacher Effort           & {\cellcolor{green!10}80\%} \\\cdashline{3-4}
\cellcolor{practice} &                                             & Content Knowledge        & {\cellcolor{red!10}27\%} \\\cdashline{3-4}
\cellcolor{practice} &                                             & Pedagogical Skills       & {\cellcolor{red!10}22\%} \\\cdashline{2-4}
\cellcolor{practice} & \multirow{2}{2cm}{Inputs \& Infrastructure} & Basic Inputs             & \cellcolor{yellow!10}3.3 \\\cdashline{3-4}
\cellcolor{practice} &                                             & Basic Infrastructure     & \cellcolor{yellow!10}3.1 \\\cdashline{2-4}
\cellcolor{practice} & \multirow{2}{2cm}{Learners}                 & Capacity for Learning    & {\cellcolor{red!10}9\%} \\\cdashline{3-4}
\cellcolor{practice} &                                             & Student Attendance       & {\cellcolor{green!10}87\%} \\\cdashline{2-4}
\cellcolor{practice} & \multirow{4}{2cm}{School Management}        & Operational Management   & \cellcolor{green!10}4 \\\cdashline{3-4}
\cellcolor{practice} &                                             & Instructional Leadership & \cellcolor{yellow!10}3.4 \\\cdashline{3-4}
\cellcolor{practice} &                                             & School Knowledge         & \cellcolor{green!10}4 \\\cdashline{3-4}
\cellcolor{practice}\multirow{-13}{*}{\rotatebox{90}{\textcolor{white}{Practices}}}  & & Management Practices  & \cellcolor{green!10}4.2 \\\cdashline{1-4}
\cellcolor{policy}   & \multirow{6}{2cm}{Teaching}                  & Attraction                    & \cellcolor{yellow!10}3.9 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Selection \& Deployment       & \cellcolor{yellow!10}3.3 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Support                       & \cellcolor{red!10}2.8 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Evaluation                    & \cellcolor{green!10}4.5 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Monitoring \& Accountability  & \cellcolor{red!10}2.9 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Intrinsic Motivation          & \cellcolor{yellow!10}3.9 \\\cdashline{2-4}
\cellcolor{policy}   & \multirow{2}{2cm}{Inputs \& infrastructure}  & Standards                     & \cellcolor{green!10}4.5 \\\cdashline{3-4} 
\cellcolor{policy}   &                                              & Monitoring                    & \cellcolor{yellow!10}3.1 \\\cdashline{2-4}
\cellcolor{policy}   & \multirow{5}{2cm}{Learners}                  & Nutrition Programs            & \cellcolor{yellow!10}3.9 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Health Programs               & \cellcolor{yellow!10}3.9 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Center based care             & \cellcolor{red!10}1.5 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Caregiver Financial Capacity  & \cellcolor{red!10}1.5 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Caregiver Skills Capacity     & \cellcolor{red!10}2.8 \\\cdashline{2-4}
\cellcolor{policy}   & \multirow{5}{2cm}{School Management}         & Clarity of Functions          & \cellcolor{green!10}4.9 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Attraction                    & \cellcolor{green!10}4.3 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Selection \& Deployment       & \cellcolor{yellow!10}3.9 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Support                       & \cellcolor{yellow!10}3.7 \\\cdashline{3-4}
\cellcolor{policy}\multirow{-18}{*}{\rotatebox{90}{\textcolor{white}{Policy levers}}} & & Evaluation           & \cellcolor{green!10}4.5 \\\cdashline{1-4}
\cellcolor{politics} & \multirow{5}{2cm}{Politics \& Bureaucratic Capacity}           & Quality of Bureaucracy & \cellcolor{yellow!10}3.9 \\\cdashline{3-4}
\cellcolor{politics} & & Impartial Decision-Making  & \cellcolor{yellow!10}3.3 \\\cdashline{3-4}
\cellcolor{politics} & & Mandates \& Accountability & \cellcolor{red!10}2.8 \\\cdashline{3-4}
\cellcolor{politics} & & National Learning Goals    & \cellcolor{green!10}4.5 \\\cdashline{3-4}
\cellcolor{politics}\multirow{-5}{*}{\rotatebox{90}{\textcolor{white}{Politics}}}     & & Financing            & \cellcolor{red!10}2.9 \\\hline
\end{tabular}}
\\
...
\hypertarget{table-2.-gepd-indicators-by-gender-rwanda-2020}{%
\paragraph{Table 2. GEPD Indicators by gender, Rwanda,
2020}\label{table-2.-gepd-indicators-by-gender-rwanda-2020}}

\begin{table}[H]
\resizebox{\columnwidth}{!}{\begin{tabular}{m{2cm}m{5cm}cc}
\textbf{Subtitle} & \textbf{Indicator} & \textbf{Male} & \textbf{Female} \\\hline
Learning                  & Proficiency on GEPD Assessment  & {\cellcolor{red!10}0.1\%} & {\cellcolor{red!10}0.2\%} \\\cdashline{1-4}
\multirow{3}{*}{Teaching} & Teacher Effort      & {\cellcolor{yellow!10}79\%} & {\cellcolor{green!10}80\%} \\\cdashline{2-4}
                          &  Content knowledge  & {\cellcolor{red!10}28\%} & {\cellcolor{red!10}26\%} \\\cdashline{2-4}
                          &  Pedagogical Skills & {NA\%} & {NA\%} \\\cdashline{1-4}
\multirow{2}{*}{Learners}   & Capacity for Learning    & {\cellcolor{red!10}52\%} & {\cellcolor{red!10}55\%} \\\cdashline{2-4}
                            & Student Attendance       & {\cellcolor{green!10}82\%} & {\cellcolor{green!10}84\%} \\\cdashline{1-4}
\multirow{4}{2cm}{School Management}  & Operational Management   & \cellcolor{green!10}4 & \cellcolor{green!10}4 \\\cdashline{2-4}
                                      & Instructional Leadership & \cellcolor{yellow!10}3.4 & \cellcolor{yellow!10}3.4 \\\cdashline{2-4}
                                      & School Knowledge         & \cellcolor{green!10}4 & \cellcolor{green!10}4 \\\cdashline{2-4}
                                      & Management Practices     & \cellcolor{green!10}4.2 & \cellcolor{green!10}4.1\\\hline
\end{tabular}}
\end{table}
\raggedbottom

\hypertarget{table-3.-gepd-indicators-by-region-rwanda-2020}{%
\paragraph{Table 3. GEPD Indicators by region, Rwanda,
2020}\label{table-3.-gepd-indicators-by-region-rwanda-2020}}

\begin{table}[H]
\resizebox{\columnwidth}{!}{\begin{tabular}{m{2cm}m{5cm}cc}
\textbf{Subtitle} & \textbf{Indicator} & \textbf{Rural} & \textbf{Urban} \\\hline
Learning                  & Proficiency on GEPD Assessment & {\cellcolor{red!10}0.1\%} & {\cellcolor{red!10}0.8\%} \\\cdashline{1-4}
\multirow{3}{*}{Teaching} & Teacher Effort                 & {\cellcolor{yellow!10}79\%} & {\cellcolor{green!10}85\%} \\\cdashline{2-4}
                          &  Content knowledge             & {\cellcolor{red!10}24\%} & {\cellcolor{red!10}45\%} \\\cdashline{2-4}
                          &  Pedagogical Skills            & {\cellcolor{red!10}23\%} & {\cellcolor{red!10}13\%} \\\cdashline{1-4}
\multirow{2}{2cm}{Inputs \& infrastructure}   & Basic Inputs             & \cellcolor{yellow!10}3.2 & \cellcolor{yellow!10}3.8 \\\cdashline{2-4}
                                              & Basic Infrastructure     & \cellcolor{yellow!10}3.1 & \cellcolor{yellow!10}3.5 \\\cdashline{1-4}
\multirow{2}{*}{Learners}   & Capacity for Learning    & {\cellcolor{red!10}52\%} & {\cellcolor{yellow!10}63\%} \\\cdashline{2-4}
                            & Student Attendance       & {\cellcolor{green!10}86\%} & {\cellcolor{green!10}93\%} \\\cdashline{1-4}
\multirow{4}{2cm}{School Management}  & Operational Management   & \cellcolor{green!10}4 & \cellcolor{green!10}4.1 \\\cdashline{2-4}
                                      & Instructional Leadership & \cellcolor{yellow!10}3.4 & \cellcolor{yellow!10}3.4 \\\cdashline{2-4}
                                      & School Knowledge         & \cellcolor{yellow!10}3.9 & \cellcolor{green!10}4.5 \\\cdashline{2-4}
                                      & Management Practices     & \cellcolor{green!10}4.2 & \cellcolor{green!10}4\\\hline
\end{tabular}}
\end{table}
\raggedbottom
...
\includegraphics{C:/Users/wb469649/ONEDRI~1/DOCUME~1/Github/GEPD/COUNTR~1/Output/RWANDA~2/figure-latex/lern_teach-1.pdf}
...
Content knowledge                   & {\cellcolor{red!10}27\%}   & Attraction                                & \cellcolor{yellow!10}3.9 \\\cdashline{1-4} 
\hspace{1mm}\emph{Maths proficiency}               & {\cellcolor{red!10}41\%} &                                           & \cellcolor{yellow!10}\\\cdashline{1-2}   
\hspace{1mm}\emph{Language proficiency}            & {\cellcolor{red!10}20\%} & \multirow{-2}{*}{Selection \& deployment} & \multirow{-2}{*}{\cellcolor{yellow!10}3.3} \\\cdashline{1-4}        
Pedagogical skills                               & {\cellcolor{red!10}22\%}   &                                           & \cellcolor{red!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Classroom culture}            & {\cellcolor{green!10}90\%} & \multirow{-2}{*}{Support}                 & \multirow{-2}{*}{\cellcolor{red!10}2.8} \\\cdashline{1-4}
\hspace{1mm}\emph{\% Instruction practices}        & {\cellcolor{red!10}20\%} &                                           & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Socio-emotional skills}       & {\cellcolor{red!10}15\%} & \multirow{-2}{*}{Evaluation}              & \multirow{-2}{*}{\cellcolor{green!10}4.5} \\\cdashline{1-4}
& \cellcolor{green!10} & Monitoring \& Accountability  & \cellcolor{red!10}2.9 \\\cdashline{3-4}
\multirow{-2}{*}{Teacher Attendance}             & \multirow{-2}{*}{\cellcolor{green!10}87\%} & Intrinsic motivation    & \cellcolor{yellow!10}3.9 \\\hline
\end{tabular}}
\\
...
Capacity for learning                  & {\cellcolor{red!10}9\%} & & \cellcolor{yellow!10}\\\cdashline{1-2}
\hspace{1mm}\emph{Numeracy score}        & \cellcolor{yellow!10}62   & \multirow{-2}{*}{Nutrition Programs} & \multirow{-2}{*}{\cellcolor{yellow!10}3.2}  \\\cdashline{1-4}  
\hspace{1mm}\emph{Literacy score}        & \cellcolor{red!10}38   & Health Programs                     & \cellcolor{yellow!10}3.5 \\\cdashline{1-4}  
\hspace{1mm}\emph{Executive score}       & \cellcolor{red!10}47   & Center based care                   & \cellcolor{red!10}1.5 \\\cdashline{1-4}  
\hspace{1mm}\emph{Socio-emotional score} & \cellcolor{yellow!10}67   & Caregiver Skills Capacity           & \cellcolor{red!10}2.8 \\\cdashline{1-4}  
Student Attendance                     & {\cellcolor{green!10}87\%}     & Caregiver Financial Capacity        & \cellcolor{red!10}2.3 \\\hline
\end{tabular}}
\\
...
Basic inputs & \cellcolor{yellow!10}3.3 & & \cellcolor{green!10} \\\cdashline{1-2}
\hspace{1mm}\emph{\% Blackboard}    & {\cellcolor{yellow!10}60\%} & & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Stationery}    & {\cellcolor{green!10}92\%} & & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Furniture}     & {\cellcolor{green!10}99\%} & & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% EdTech access} & {\cellcolor{yellow!10}76\%} & \multirow{-5}{4.2cm}{Inputs and infrastructure standards} & \multirow{-5}{*}{\cellcolor{green!10}4.5}\\\hline
Basic infrastructure & \cellcolor{yellow!10}3.1 & & \cellcolor{yellow!10} \\\cdashline{1-2}
\hspace{1mm}\emph{\% Drinking water}    & {\cellcolor{yellow!10}74\%} & & \cellcolor{yellow!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Functional toilet} & {\cellcolor{red!10}57\%} & & \cellcolor{yellow!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Internet}          & {\cellcolor{yellow!10}78\%} & & \cellcolor{yellow!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Electricity}       & {\cellcolor{red!10}27\%} & & \cellcolor{yellow!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Disability access} & {\cellcolor{yellow!10}75\%} & \multirow{-6}{4.2cm}{Inputs and infrastructure monitoring} & \multirow{-6}{*}{\cellcolor{yellow!10}3.1}\\\hline
\end{tabular}}
\\
...
Operational management                     & \cellcolor{green!10}4       & & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{Infrastructure}            & \cellcolor{green!10}4.5     & & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{Ensuring inputs}           & \cellcolor{yellow!10}3.5     & & \cellcolor{green!10}\\\cdashline{1-2}
Instructional Leadership                   & \cellcolor{yellow!10}3.4       & & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Classroom observed}     & {\cellcolor{green!10}88\%} & & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Discussed observations} & {\cellcolor{red!10}51\%} & & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Feedback given}         & {\cellcolor{yellow!10}70\%} & & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Lesson-plan feedback}   & {\cellcolor{red!10}44\%} & \multirow{-8}{*}{Clarity of functions} & \multirow{-8}{*}{\cellcolor{green!10}4.9} \\\hline
Principal school knowledge                         & \cellcolor{green!10}4       & & \cellcolor{green!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Teachers' knowledge}  & {\cellcolor{green!10}80\%} & \multirow{-2}{4cm}{Attraction} & \multirow{-2}{*}{\cellcolor{green!10}4.3}\\\cdashline{1-4}
\hspace{1mm}\emph{\% Teachers' experience} & {\cellcolor{green!10}99\%} & & \cellcolor{yellow!10}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Input availability}      & {\cellcolor{yellow!10}77\%} & \multirow{-2}{4cm}{Selection \& Deployment} & \multirow{-2}{*}{\cellcolor{yellow!10}3.9} \\\cdashline{1-4} 
...
\includegraphics{C:/Users/wb469649/ONEDRI~1/DOCUME~1/Github/GEPD/COUNTR~1/Output/RWANDA~2/figure-latex/defacto_graphs-1.pdf}
...
\includegraphics{C:/Users/wb469649/ONEDRI~1/DOCUME~1/Github/GEPD/COUNTR~1/Output/RWANDA~2/figure-latex/defacto_sub_graphs_1-1.pdf}
...
\includegraphics{C:/Users/wb469649/ONEDRI~1/DOCUME~1/Github/GEPD/COUNTR~1/Output/RWANDA~2/figure-latex/defacto_sub_graphs_2-1.pdf}
...
\includegraphics{C:/Users/wb469649/ONEDRI~1/DOCUME~1/Github/GEPD/COUNTR~1/Output/RWANDA~2/figure-latex/defacto_sub_graphs_3-1.pdf}
...
\includegraphics{C:/Users/wb469649/ONEDRI~1/DOCUME~1/Github/GEPD/COUNTR~1/Output/RWANDA~2/figure-latex/politics_graph-1.pdf}
...
\textbf{Indicator} & \textbf{Sub-indicator}  & \textbf{Value}  \\\hline
                                   & Knowledge and skills & \cellcolor{green!10}4.9 \\\cdashline{2-3}
                                   & Work enviornment &\cellcolor{green!10}4.3 \\\cdashline{2-3}
                                   & Merit &\cellcolor{green!10}4.2 \\\cdashline{2-3}
\multirow{-4}{2cm}{Quality of bureaucracy (1-5)} & Motivation and attitudes &\cellcolor{green!10}4.4 \\\hline
                                   & Politicized personnel management &\cellcolor{yellow!10}3.8 \\\cdashline{2-3}
                                   & Politicized policy-making &\cellcolor{yellow!10}3.8 \\\cdashline{2-3}
                                   & Politicized policy implementation &\cellcolor{yellow!10}3.1 \\\cdashline{2-3}
\multirow{-4}{2cm}{Impartial decision making (1-5)} & Employee unions as facilitators &\cellcolor{green!10}4.7 \\\hline
                                   & Coherence &\cellcolor{green!10}4.1 \\\cdashline{2-3}
                                   & Transparency &\cellcolor{green!10}4.5 \\\cdashline{2-3}
\multirow{-3}{2cm}{Mandates and accountability (1-5)} & Public official accountability &\cellcolor{green!10}4.8 \\\hline
                                   & Targeting &\cellcolor{green!10}4.8 \\\cdashline{2-3}
                                   & Monitoring &\cellcolor{green!10}4.3 \\\cdashline{2-3}
                                   & Incentives &\cellcolor{yellow!10}3.8 \\\cdashline{2-3}
