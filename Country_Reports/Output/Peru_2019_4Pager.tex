...
\cellcolor{outcome} &                             & Proficiency by End of Primary  & {\cellcolor{red!15}54\%} \\\cdashline{3-4}
\cellcolor{outcome} &                             & Proficiency on GEPD Assessment & {\cellcolor{red!15}33\%} \\\cdashline{2-4}
\cellcolor{outcome} &  Participation              & Net Adjusted Enrollment Rate   & {NA} \\\cdashline{2-4}
\cellcolor{outcome}\multirow{-5}{*}{\rotatebox{90}{\textcolor{white}{Outcomes}}} &  Participation and learning  & Learning poverty & {\cellcolor{red!15}56\%}\\\cdashline{1-4}
\cellcolor{practice} & \multirow{3}{2cm}{Teaching}                 & Teacher Presence           & {\cellcolor{green!15}91\%} \\\cdashline{3-4}
...
\end{tabular}}
\\
\setstretch{0.8}\color{darkgray}\scriptsize{\textit{Source:} UIS, GLAD, GEPD, World Bank, Peru, 2020. For information on indicators, please consult the World Bank \href{https://github.com/worldbank/GEPD}{\underline{GEPD}}, \href{https://github.com/worldbank/GLAD}{\underline{GLAD}} and \href{https://github.com/worldbank/LearningPoverty}{\underline{Learning Poverty}} repositories.}\\
...
\hypertarget{table-2.-gepd-indicators-by-gender-peru-2020}{%
\paragraph{Table 2. GEPD Indicators by gender, Peru,
2020}\label{table-2.-gepd-indicators-by-gender-peru-2020}}
...
\multirow{3}{*}{Teaching} & Teacher Presence      & {\cellcolor{yellow!15}89\%} & {\cellcolor{green!15}91\%} \\\cdashline{2-4}
                          &  Content knowledge  & {\cellcolor{red!15}38\%} & {\cellcolor{red!15}39\%} \\\cdashline{2-4}
                          &  Pedagogical Skills & {NA} & {NA} \\\cdashline{1-4}
\multirow{2}{*}{Learners}   & Capacity for Learning    & {\cellcolor{red!15}76\%} & {\cellcolor{red!15}78\%} \\\cdashline{2-4}
...
\hypertarget{table-3.-gepd-indicators-by-region-peru-2020}{%
\paragraph{Table 3. GEPD Indicators by region, Peru,
2020}\label{table-3.-gepd-indicators-by-region-peru-2020}}
...
\multirow{3}{*}{Teaching} & Teacher Presence                 & {\cellcolor{green!15}91\%} & {\cellcolor{green!15}91\%} \\\cdashline{2-4}
...
\multirow{2}{*}{Learners}   & Capacity for Learning    & {\cellcolor{red!15}63\%} & {\cellcolor{red!15}80\%} \\\cdashline{2-4}
...
\includegraphics[width=1\linewidth]{C:/Users/wb469649/Documents/Github/GEPD/Country_Reports/LP_LAYS_figures/lp_figure_PER}
...
\includegraphics{C:/Users/wb469649/Documents/Github/GEPD/Country_Reports/Output/Peru_2019_4Pager_files/figure-latex/lern_teach-1.pdf}
...
\hspace{1mm}\emph{Literacy score}        & \cellcolor{red!15}77   & Health Programs                     & \cellcolor{green!15}4.2 \\\cdashline{1-4}  
\hspace{1mm}\emph{Executive score}       & \cellcolor{red!15}65   & Center based care                   & \cellcolor{red!15}2.6 \\\cdashline{1-4}  
\hspace{1mm}\emph{Socio-emotional score} & \cellcolor{red!15}75   & Caregiver Skills Capacity           & \cellcolor{red!15}2.9 \\\cdashline{1-4}  
...
\hspace{1mm}\emph{\% Blackboard}    & {\cellcolor{red!15}82\%} & & \cellcolor{yellow!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Stationery}    & {\cellcolor{green!15}96\%} & & \cellcolor{yellow!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Furniture}     & {\cellcolor{red!15}84\%} & & \cellcolor{yellow!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% EdTech access} & {\cellcolor{red!15}78\%} & \multirow{-5}{4.2cm}{Inputs and infrastructure standards} & \multirow{-5}{*}{\cellcolor{yellow!15}3.7}\\\hline
...
\hspace{1mm}\emph{\% Functional toilet} & {\cellcolor{red!15}68\%} & & \cellcolor{yellow!15}\\\cdashline{1-2}
...
\hspace{1mm}\emph{\% Classroom observed}     & {\cellcolor{yellow!15}86\%} & & \cellcolor{green!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Discussed observations} & {\cellcolor{red!15}24\%} & & \cellcolor{green!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Feedback given}         & {\cellcolor{red!15}71\%} & & \cellcolor{green!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Lesson-plan feedback}   & {\cellcolor{red!15}73\%} & \multirow{-8}{*}{Clarity of functions} & \multirow{-8}{*}{\cellcolor{green!15}5} \\\hline
Principal school knowledge                         & \cellcolor{yellow!15}3.6       & & \cellcolor{green!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Teachers' knowledge}  & {\cellcolor{red!15}75\%} & \multirow{-2}{4cm}{Attraction} & \multirow{-2}{*}{\cellcolor{green!15}4.4}\\\cdashline{1-4}
\hspace{1mm}\emph{\% Teachers' experience} & {\cellcolor{green!15}99\%} & & \cellcolor{green!15}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Input availability}      & {\cellcolor{red!15}81\%} & \multirow{-2}{4cm}{Selection \& Deployment} & \multirow{-2}{*}{\cellcolor{green!15}4.4} \\\cdashline{1-4} 
...
\includegraphics{C:/Users/wb469649/Documents/Github/GEPD/Country_Reports/Output/Peru_2019_4Pager_files/figure-latex/defacto_graphs-1.pdf}
...
\includegraphics{C:/Users/wb469649/Documents/Github/GEPD/Country_Reports/Output/Peru_2019_4Pager_files/figure-latex/defacto_sub_graphs_1-1.pdf}
...
\includegraphics{C:/Users/wb469649/Documents/Github/GEPD/Country_Reports/Output/Peru_2019_4Pager_files/figure-latex/defacto_sub_graphs_2-1.pdf}
...
\includegraphics{C:/Users/wb469649/Documents/Github/GEPD/Country_Reports/Output/Peru_2019_4Pager_files/figure-latex/defacto_sub_graphs_3-1.pdf}
...
\includegraphics{C:/Users/wb469649/Documents/Github/GEPD/Country_Reports/Output/Peru_2019_4Pager_files/figure-latex/politics_graph-1.pdf}
...
\textbf{Indicator} & \textbf{Sub-indicator}  & \textbf{Value}  \\\hline
                                   & Knowledge and skills & \cellcolor{yellow!15}3.9 \\\cdashline{2-3}
                                   & Work enviornment &\cellcolor{green!15}4 \\\cdashline{2-3}
                                   & Merit &\cellcolor{yellow!15}3.2 \\\cdashline{2-3}
\multirow{-4}{2cm}{Quality of bureaucracy (Scale 1-5)} & Motivation and attitudes &\cellcolor{green!15}4.3 \\\hline
                                   & Politicized personnel management &\cellcolor{yellow!15}3.5 \\\cdashline{2-3}
                                   & Politicized policy-making &\cellcolor{yellow!15}3.6 \\\cdashline{2-3}
                                   & Politicized policy implementation &\cellcolor{red!15}2.9 \\\cdashline{2-3}
\multirow{-4}{2cm}{Impartial decision making (Scale 1-5)} & Employee unions as facilitators &\cellcolor{green!15}4 \\\hline
                                   & Coherence &\cellcolor{green!15}4 \\\cdashline{2-3}
                                   & Transparency &\cellcolor{green!15}4.1 \\\cdashline{2-3}
\multirow{-3}{2cm}{Mandates and accountability (Scale 1-5)} & Public official accountability &\cellcolor{green!15}4.6 \\\hline
                                   & Targeting &\cellcolor{green!15}4.2 \\\cdashline{2-3}
                                   & Monitoring &\cellcolor{yellow!15}3.7 \\\cdashline{2-3}
                                   & Incentives &\cellcolor{red!15}2.6 \\\cdashline{2-3}
\multirow{-4}{2cm}{National learning goals (Scale 1-5)} & Community engagement &\cellcolor{red!15}2.4 \\\hline
                                   & Per child spending adequacy &1 \\\cdashline{2-3}
                                   & Public expenditure and financial accountability efficiency &-999 \\\cdashline{2-3}
                                   & Financing and efficiency outcome &-999 \\\cdashline{2-3}
