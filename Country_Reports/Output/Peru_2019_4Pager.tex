...
\includegraphics[width=1\linewidth]{/Users/kanikaverma/Documents/GitHub/gepd/Country_Reports/LP figures/lp_figure_PER}
...
proficiency in Peru is 33\%. Student proficiency in language is 38
points higher in language compared to numeracy, 2 points higher for boys
...
Teaching - Monitoring \& Accountability policy lever scores the
lowest(2.8/5).
...
Monitoring policy lever scores the lowest(3.7/5).
...
for Operational Management(4.3/5). School Management- Support policy
...
\multirow{-4}{2cm}{Quality of bureaucracy (1-5)} & Motivation and attitudes &\cellcolor{green!15}4.3 \\\hline
...
\multirow{-4}{2cm}{Impartial decision making (1-5)} & Employee unions as facilitators &\cellcolor{green!15}4 \\\hline
                                   & Coherence &\cellcolor{green!15}4 \\\cdashline{2-3}
                                   & Transparency &\cellcolor{green!15}4.1 \\\cdashline{2-3}
\multirow{-3}{2cm}{Mandates and accountability (1-5)} & Public official accountability &\cellcolor{green!15}4.6 \\\hline
...
\multirow{-4}{2cm}{National learning goals (1-5)} & Community engagement &\cellcolor{red!15}2.4 \\\hline
