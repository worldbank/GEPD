...
(36\%). Teacher pedagogical skills score (34\%) needs improvement, and
teacher attendance (92\%) is on target. Teaching - Monitoring \&
Accountability policy lever scores the lowest(2.8/5).
...
Management(4.3/5). School Management- Support policy lever scores the
lowest(3.5/5).
...
\\
{\scriptsize
    \textcolor{darkgray}{\textit{Notes:} Financing sub-indicators are on a 0-1 scale, the other sub-indicators are on 0-1 scale.}
  }
