...
Learning poverty & {\cellcolor{red}54\%} \\\cdashline{1-2}
Proficiency by End of Primary & {\cellcolor{red}56\%} \\\cdashline{1-2}
Proficiency on GEPD Assessment & {\cellcolor{red}33\%} \\\cdashline{1-2}
\hspace{1mm}\emph{Literacy proficiency} & {\cellcolor{yellow}61\%} \\\cdashline{1-2}
\hspace{1mm}\emph{Numeracy proficiency} & {\cellcolor{red}23\%} \\\cdashline{1-2}
...
Grade 1 knowledge & {\cellcolor{yellow}76\%} & {\cellcolor{yellow}78\%}\\\cdashline{1-3}
Teacher Content Proficiency  & {\cellcolor{red}38\%} & {\cellcolor{red}39\%}\\\cdashline{1-3}
Student attendance & {\cellcolor{green}93\%} & {\cellcolor{green}91\%}\\\cdashline{1-3}
Teacher attendance & {\cellcolor{green}91\%} & {\cellcolor{green}92\%}\\\hline
\end{tabular}}
\\
...
\multicolumn{2}{c}{\textbf{Practice Indicators}} & \multicolumn{2}{c}{\textbf{Policy lever indicators}}\\\hline
Operational management                       & \cellcolor{green}4.3                  & \multirow{2}{*}{Clarity of functions} & \multirow{2}{*}{\cellcolor{green}5} \\\cdashline{1-2}
Instructional Leadership                     & \cellcolor{yellow}3.3                  & &  \cellcolor{green} \\\hline
\multirow{2}{*}{Principal School knowledge}  & \multirow{2}{*}{\cellcolor{yellow}3.6} & Attraction & \cellcolor{green}4.4\\\cdashline{3-4}
 & \cellcolor{yellow} & Selection \& Deployment & \cellcolor{green}4.4\\\cdashline{3-4}
\multirow{2}{*}{Principal Management skills} & \multirow{2}{*}{\cellcolor{green}4.3} & Support & \cellcolor{yellow}3.5\\\cdashline{3-4}
 & \cellcolor{green} & Evaluation              & \cellcolor{green}4.4\\\hline
\end{tabular}}
\\
{\scriptsize
...
\resizebox{\columnwidth}{!}{\begin{tabular}{p{0.4\textwidth}c}
\textbf{Indicator} & \textbf{Value}\\ \hline
Quality of Bureaucracy & \cellcolor{green}4\\\cdashline{1-2}
Impartial Decision-Making & \cellcolor{yellow}3.3\\\cdashline{1-2}
Mandates \& Accountability & \cellcolor{green}4.2\\\cdashline{1-2}
National Learning Goals & \cellcolor{yellow}3\\\cdashline{1-2}
Financing & \cellcolor{green}5\\\hline
\end{tabular}}
\\
{\scriptsize
    \textcolor{darkgray}{\textit{Source:} All scores are on a (0-5) scale.}
