...
\includegraphics[width=1\linewidth]{/Users/kanikaverma/Documents/GitHub/gepd/Country_Reports/LP figures/lp_figure_JOR}
...
(58\%). Teacher pedagogical skills score (68\%) requires caution, and
teacher attendance (93\%) is on target. Teaching - Support policy lever
scores the lowest(2.6/5).
...
Management(4.7/5). School Management- Support policy lever scores the
lowest(3.5/5).
...
\multirow{-4}{2cm}{Quality of bureaucracy (1-5)} & Motivation and attitudes &\cellcolor{yellow!15}3.3 \\\hline
...
\multirow{-4}{2cm}{Impartial decision making (1-5)} & Employee unions as facilitators &\cellcolor{yellow!15}3 \\\hline
                                   & Coherence &\cellcolor{green!15}4 \\\cdashline{2-3}
                                   & Transparency &\cellcolor{green!15}4.2 \\\cdashline{2-3}
\multirow{-3}{2cm}{Mandates and accountability (1-5)} & Public official accountability &\cellcolor{green!15}4.4 \\\hline
