...
\hypertarget{table-1.-gepd-indicators-jordan-2019}{%
\paragraph{Table 1. GEPD Indicators, Jordan,
2019}\label{table-1.-gepd-indicators-jordan-2019}}

\begin{table}[H]
\resizebox{\columnwidth}{!}{\begin{tabular}{cm{2cm}m{5cm}c}
& \textbf{Subtitle} & \textbf{Indicator} & \textbf{Overall} \\ \hline
\cellcolor{outcome} & \multirow{3}{2cm}{Learning} & Proficiency by Grade 2/3       & {\cellcolor{red!30}-999\%} \\\cdashline{3-4}
\cellcolor{outcome} &                             & Proficiency by End of Primary  & {\%} \\\cdashline{3-4}
\cellcolor{outcome} &                             & Proficiency on GEPD Assessment & {\cellcolor{red!30}4.4\%} \\\cdashline{2-4}
\cellcolor{outcome} &  Participation              & Net Adjusted Enrollment Rate   & {\%} \\\cdashline{2-4}
\cellcolor{outcome}\multirow{-5}{*}{\rotatebox{90}{\textcolor{white}{Outcomes}}} &  Participation and learning  & Learning Poverty Rate & {\cellcolor{red!30}52\%} \\\cdashline{1-4}
\cellcolor{practice} & \multirow{3}{2cm}{Teaching}                 & Teacher Effort           & {\cellcolor{green!30}82\%} \\\cdashline{3-4}
\cellcolor{practice} &                                             & Content Knowledge        & {\cellcolor{red!30}34\%} \\\cdashline{3-4}
\cellcolor{practice} &                                             & Pedagogical Skills       & {\cellcolor{yellow!30}68\%} \\\cdashline{2-4}
\cellcolor{practice} & \multirow{2}{2cm}{Inputs \& Infrastructure} & Basic Inputs             & \cellcolor{green!30}4.3 \\\cdashline{3-4}
\cellcolor{practice} &                                             & Basic Infrastructure     & \cellcolor{green!30}4.1 \\\cdashline{2-4}
\cellcolor{practice} & \multirow{2}{2cm}{Learners}                 & Capacity for Learning    & {\cellcolor{red!30}37\%} \\\cdashline{3-4}
\cellcolor{practice} &                                             & Student Attendance       & {\cellcolor{green!30}97\%} \\\cdashline{2-4}
\cellcolor{practice} & \multirow{4}{2cm}{School Management}        & Operational Management   & \cellcolor{green!30}4.7 \\\cdashline{3-4}
\cellcolor{practice} &                                             & Instructional Leadership & \cellcolor{yellow!30}3.3 \\\cdashline{3-4}
\cellcolor{practice} &                                             & School Knowledge         & \cellcolor{yellow!30}3.8 \\\cdashline{3-4}
\cellcolor{practice}\multirow{-13}{*}{\rotatebox{90}{\textcolor{white}{Practices}}}  & & Management Practices  & \cellcolor{green!30}4 \\\cdashline{1-4}
\cellcolor{policy}   & \multirow{6}{2cm}{Teaching}                  & Attraction                    & \cellcolor{yellow!30}3.5 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Selection \& Deployment       & \cellcolor{yellow!30}3.5 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Support                       & \cellcolor{red!30}2.6 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Evaluation                    & \cellcolor{yellow!30}3.6 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Monitoring \& Accountability  & \cellcolor{yellow!30}3.1 \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Intrinsic Motivation          & \cellcolor{yellow!30}3.4 \\\cdashline{2-4}
\cellcolor{policy}   & \multirow{2}{2cm}{Inputs \& infrastructure}  & Standards                     & \cellcolor{yellow!30}3.8 \\\cdashline{3-4} 
\cellcolor{policy}   &                                              & Monitoring                    & \cellcolor{yellow!30}3 \\\cdashline{2-4}
\cellcolor{policy}   & \multirow{5}{2cm}{Learners}                  & Nutrition Programs            & \cellcolor{yellow!30}3.5 \\\cdashline{3-4}
...
\hypertarget{table-2.-gepd-indicators-by-gender-jordan-2019}{%
\paragraph{Table 2. GEPD Indicators by gender, Jordan,
2019}\label{table-2.-gepd-indicators-by-gender-jordan-2019}}

\begin{table}[H]
\resizebox{\columnwidth}{!}{\begin{tabular}{m{2cm}m{5cm}cc}
\textbf{Subtitle} & \textbf{Indicator} & \textbf{Male} & \textbf{Female} \\ \hline
Learning                  & Proficiency on GEPD Assessment  & {\cellcolor{red!30}3.9\%} & {\cellcolor{red!30}6\%} \\\cdashline{1-4}
\multirow{3}{*}{Teaching} & Teacher Effort      & {\cellcolor{green!30}83\%} & {\cellcolor{green!30}82\%} \\\cdashline{2-4}
                          &  Content knowledge  & {\cellcolor{red!30}32\%} & {\cellcolor{red!30}35\%} \\\cdashline{2-4}
                          &  Pedagogical Skills & {NA\%} & {NA\%} \\\cdashline{1-4}
\multirow{2}{*}{Learners}   & Capacity for Learning    & {\cellcolor{yellow!30}74\%} & {\cellcolor{yellow!30}75\%} \\\cdashline{2-4}
                            & Student Attendance       & {\cellcolor{yellow!30}78\%} & {\cellcolor{green!30}82\%} \\\cdashline{1-4}
\multirow{4}{2cm}{School Management}  & Operational Management   & \cellcolor{green!30}4.6 & \cellcolor{green!30}4.7 \\\cdashline{2-4}
                                      & Instructional Leadership & \cellcolor{yellow!30}3.1 & \cellcolor{yellow!30}3.3 \\\cdashline{2-4}
                                      & School Knowledge         & \cellcolor{yellow!30}3.3 & \cellcolor{yellow!30}3.9 \\\cdashline{2-4}
                                      & Management Practices     & \cellcolor{yellow!30}3.9 & \cellcolor{green!30}4\\\hline
\end{tabular}}
\end{table}

\hypertarget{table-3.-gepd-indicators-by-region-jordan-2019}{%
\paragraph{Table 3. GEPD Indicators by region, Jordan,
2019}\label{table-3.-gepd-indicators-by-region-jordan-2019}}

\begin{table}[H]
\resizebox{\columnwidth}{!}{\begin{tabular}{m{2cm}m{5cm}cc}
\textbf{Subtitle} & \textbf{Indicator} & \textbf{Rural} & \textbf{Urban} \\ \hline
Learning                  & Proficiency on GEPD Assessment & {\cellcolor{red!30}6\%} & {\cellcolor{red!30}4\%} \\\cdashline{1-4}
\multirow{3}{*}{Teaching} & Teacher Effort                 & {\cellcolor{yellow!30}79\%} & {\cellcolor{green!30}83\%} \\\cdashline{2-4}
                          &  Content knowledge             & {\cellcolor{red!30}35\%} & {\cellcolor{red!30}33\%} \\\cdashline{2-4}
                          &  Pedagogical Skills            & {\cellcolor{red!30}57\%} & {\cellcolor{yellow!30}71\%} \\\cdashline{1-4}
\multirow{2}{2cm}{Inputs \& infrastructure}   & Basic Inputs             & \cellcolor{green!30}4.2 & \cellcolor{green!30}4.3 \\\cdashline{2-4}
                                              & Basic Infrastructure     & \cellcolor{green!30}4 & \cellcolor{green!30}4.2 \\\cdashline{1-4}
\multirow{2}{*}{Learners}   & Capacity for Learning    & {\cellcolor{yellow!30}74\%} & {\cellcolor{yellow!30}73\%} \\\cdashline{2-4}
                            & Student Attendance       & {\cellcolor{green!30}99\%} & {\cellcolor{green!30}97\%} \\\cdashline{1-4}
\multirow{4}{2cm}{School Management}  & Operational Management   & \cellcolor{green!30}4.6 & \cellcolor{green!30}4.7 \\\cdashline{2-4}
                                      & Instructional Leadership & \cellcolor{yellow!30}3.2 & \cellcolor{yellow!30}3.3 \\\cdashline{2-4}
                                      & School Knowledge         & \cellcolor{green!30}4 & \cellcolor{yellow!30}3.7 \\\cdashline{2-4}
                                      & Management Practices     & \cellcolor{green!30}4.1 & \cellcolor{green!30}4\\\hline
\end{tabular}}
\end{table}
...
\includegraphics{C:/Users/wb469649/OneDrive - WBG/Documents/Github/GEPD/Country_Reports/Output/Jordan_2019_4Pager_files/figure-latex/lp_fig-1.pdf}
...
\includegraphics{C:/Users/wb469649/OneDrive - WBG/Documents/Github/GEPD/Country_Reports/Output/Jordan_2019_4Pager_files/figure-latex/lern_teach-1.pdf}
...
Content knowledge                   & {\cellcolor{red!30}34\%}   & Attraction                                & \cellcolor{yellow!30}3.5 \\\cdashline{1-4} 
\hspace{1mm}\emph{Maths proficiency}               & {\cellcolor{red!30}58\%} &                                           & \cellcolor{yellow!30}\\\cdashline{1-2}   
\hspace{1mm}\emph{Language proficiency}            & {\cellcolor{red!30}25\%} & \multirow{-2}{*}{Selection \& deployment} & \multirow{-2}{*}{\cellcolor{yellow!30}3.5} \\\cdashline{1-4}        
Pedagogical skills                               & {\cellcolor{yellow!30}68\%}   &                                           & \cellcolor{red!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Classroom culture}            & {\cellcolor{yellow!30}72\%} & \multirow{-2}{*}{Support}                 & \multirow{-2}{*}{\cellcolor{red!30}2.6} \\\cdashline{1-4}
\hspace{1mm}\emph{\% Instruction practices}        & {\cellcolor{yellow!30}74\%} &                                           & \cellcolor{yellow!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Socio-emotional skills}       & {\cellcolor{yellow!30}68\%} & \multirow{-2}{*}{Evaluation}              & \multirow{-2}{*}{\cellcolor{yellow!30}3.6} \\\cdashline{1-4}
& \cellcolor{green!30} & Monitoring \& Accountability  & \cellcolor{yellow!30}3.1 \\\cdashline{3-4}
\multirow{-2}{*}{Teacher Attendance}             & \multirow{-2}{*}{\cellcolor{green!30}93\%} & Intrinsic motivation    & \cellcolor{yellow!30}3.4 \\\hline
\end{tabular}}
\\
{\scriptsize
...
\resizebox{\columnwidth}{!}{\begin{tabular}{m{3.8cm}cm{4.2cm}c}
\multicolumn{2}{c}{\textbf{Practice Indicators}} & \multicolumn{2}{c}{\textbf{Policy lever indicators}}\\\hline
Capacity for learning                  & {\cellcolor{red!30}37\%} & & \cellcolor{yellow!30}\\\cdashline{1-2}
\hspace{1mm}\emph{Numeracy score}        & \cellcolor{green!30}92   & \multirow{-2}{*}{Nutrition Programs} & \multirow{-2}{*}{\cellcolor{yellow!30}3.5}  \\\cdashline{1-4}  
\hspace{1mm}\emph{Literacy score}        & \cellcolor{yellow!30}76   & Health Programs                     & \cellcolor{yellow!30}3.6 \\\cdashline{1-4}  
\hspace{1mm}\emph{Executive score}       & \cellcolor{yellow!30}68   & Center based care                   & \cellcolor{red!30}1.5 \\\cdashline{1-4}  
\hspace{1mm}\emph{Socio-emotional score} & \cellcolor{red!30}56   & Caregiver Skills Capacity           & \cellcolor{green!30}4.7 \\\cdashline{1-4}  
Student Attendance                     & {\cellcolor{green!30}97\%}     & Caregiver Financial Capacity        & \cellcolor{green!30}4.4 \\\hline
\end{tabular}}
\\
{\scriptsize
...
\resizebox{\columnwidth}{!}{\begin{tabular}{m{3.8cm}cm{4.2cm}c}
\multicolumn{2}{c}{\textbf{Practice Indicators}} & \multicolumn{2}{c}{\textbf{Policy lever indicators}}\\\hline
Basic inputs & \cellcolor{green!30}4.3 & & \cellcolor{yellow!30} \\\cdashline{1-2}
\hspace{1mm}\emph{\% Blackboard}    & {\cellcolor{green!30}87\%} & & \cellcolor{yellow!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Stationery}    & {\cellcolor{green!30}98\%} & & \cellcolor{yellow!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Furniture}     & {\cellcolor{green!30}88\%} & & \cellcolor{yellow!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% EdTech access} & {\cellcolor{green!30}89\%} & \multirow{-5}{4.2cm}{Inputs and infrastructure standards} & \multirow{-5}{*}{\cellcolor{yellow!30}3.8}\\\hline
Basic infrastructure & \cellcolor{green!30}4.1 & & \cellcolor{yellow!30} \\\cdashline{1-2}
\hspace{1mm}\emph{\% Drinking water}    & {\cellcolor{green!30}89\%} & & \cellcolor{yellow!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Functional toilet} & {\cellcolor{yellow!30}69\%} & & \cellcolor{yellow!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Internet}          & {\cellcolor{green!30}100\%} & & \cellcolor{yellow!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Electricity}       & {\cellcolor{green!30}88\%} & & \cellcolor{yellow!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Disability access} & {\cellcolor{yellow!30}66\%} & \multirow{-6}{4.2cm}{Inputs and infrastructure monitoring} & \multirow{-6}{*}{\cellcolor{yellow!30}3}\\\hline
\end{tabular}}
\\
{\scriptsize
...
\multicolumn{2}{c}{\textbf{Practice Indicators}} & \multicolumn{2}{c}{\textbf{Policy lever indicators}}\\\hline
Operational management                     & \cellcolor{green!30}4.7       & & \cellcolor{green!30}\\\cdashline{1-2}
\hspace{1mm}\emph{Infrastructure}            & \cellcolor{green!30}4.4     & & \cellcolor{green!30}\\\cdashline{1-2}
\hspace{1mm}\emph{Ensuring inputs}           & \cellcolor{green!30}5     & & \cellcolor{green!30}\\\cdashline{1-2}
Instructional Leadership                   & \cellcolor{yellow!30}3.3       & & \cellcolor{green!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Classroom observed}     & {\cellcolor{yellow!30}75\%} & & \cellcolor{green!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Discussed observations} & {\cellcolor{red!30}27\%} & & \cellcolor{green!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Feedback given}         & {\cellcolor{red!30}53\%} & & \cellcolor{green!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Lesson-plan feedback}   & {\cellcolor{yellow!30}66\%} & \multirow{-8}{*}{Clarity of functions} & \multirow{-8}{*}{\cellcolor{green!30}5} \\\hline
Principal school knowledge                         & \cellcolor{yellow!30}3.8       & & \cellcolor{green!30}\\\cdashline{1-2}
\hspace{1mm}\emph{\% Familiarity-teacher knowledge}  & {\cellcolor{yellow!30}71\%} & \multirow{-2}{4cm}{Attraction} & \multirow{-2}{*}{\cellcolor{green!30}4.5}\\\cdashline{1-4}
...
\includegraphics{C:/Users/wb469649/OneDrive - WBG/Documents/Github/GEPD/Country_Reports/Output/Jordan_2019_4Pager_files/figure-latex/defacto_graphs-1.pdf}
...
\includegraphics{C:/Users/wb469649/OneDrive - WBG/Documents/Github/GEPD/Country_Reports/Output/Jordan_2019_4Pager_files/figure-latex/defacto_sub_graphs_1-1.pdf}
...
\includegraphics{C:/Users/wb469649/OneDrive - WBG/Documents/Github/GEPD/Country_Reports/Output/Jordan_2019_4Pager_files/figure-latex/defacto_sub_graphs_2-1.pdf}
...
\includegraphics{C:/Users/wb469649/OneDrive - WBG/Documents/Github/GEPD/Country_Reports/Output/Jordan_2019_4Pager_files/figure-latex/defacto_sub_graphs_3-1.pdf}
...
\includegraphics{C:/Users/wb469649/OneDrive - WBG/Documents/Github/GEPD/Country_Reports/Output/Jordan_2019_4Pager_files/figure-latex/politics_graph-1.pdf}
...
Knowledge and skills &\cellcolor{green!30}4.7 \\\cdashline{1-2}
Work enviornment &\cellcolor{green!30}4.1 \\\cdashline{1-2}
Merit &\cellcolor{yellow!30}3.5 \\\cdashline{1-2}
Motivation and attitudes &\cellcolor{yellow!30}3.3 \\\hline
\textbf\textit{Impartial decision making (Scale 1-5)} & \\
Politicized personnel management &\cellcolor{yellow!30}3.1 \\\cdashline{1-2}
Politicized policy-making &\cellcolor{yellow!30}3.8 \\\cdashline{1-2}
Politicized policy implementation &\cellcolor{red!30}2.8 \\\cdashline{1-2}
Employee unions as facilitators &\cellcolor{yellow!30}3 \\\hline
\textbf\textit{Mandates and accountability (Scale 1-5)} & \\
Coherence &\cellcolor{green!30}4 \\\cdashline{1-2}
Transparency &\cellcolor{green!30}4.2 \\\cdashline{1-2}
Public official accountability &\cellcolor{green!30}4.4 \\\hline
\textbf\textit{National learning goals (Scale 1-5)} & \\
Targeting &\cellcolor{green!30}4 \\\cdashline{1-2}
Monitoring &\cellcolor{yellow!30}3.9 \\\cdashline{1-2}
Incentives &\cellcolor{red!30}2.9 \\\cdashline{1-2}
Community engagement &\cellcolor{yellow!30}3.5 \\\hline
