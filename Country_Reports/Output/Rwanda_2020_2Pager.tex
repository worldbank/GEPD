...
Learning poverty & {\cellcolor{red!15}-999\%} \\\cdashline{1-2}
Proficiency by End of Primary & {\cellcolor{red!15}-999\%} \\\cdashline{1-2}
...
\end{tabular}} \textbackslash{} \setstretch{0.8}{{\scriptsize
    \textcolor{darkgray}{\textit{Source:} UIS, GLAD, GEPD, World Bank, Rwanda, 2020. For information on indicators, please consult the World Bank \href{https://github.com/worldbank/GEPD}{\underline{GEPD}}, \href{https://github.com/worldbank/GLAD}{\underline{GLAD}} and \href{https://github.com/worldbank/LearningPoverty}{\underline{Learning Poverty}} repositories.}
  }
}\textbackslash{}
\textbackslash{}setstretch\{0.8\}\{\textbackslash{}greynote\{(1)
Proficiency in GEPD assessments means \% students scoring
\textgreater\{80\%\}. (2) Proficiency by end of primary uses cutoff of
Minimum Proficiency Levels (MPLs) defined by the Global Alliance to
Monitor Learning(UIS). (3) All indicators are on a scale of 0-5 unless
measured in \%. (4) Green indicates indicator `on-target', yellow
indicates `requires caution', red indicates `needs improvement'\}\}
\textbackslash{}end\{table\} \raggedbottom

\hypertarget{learning-outcomes-learning-poverty-0-gepd-proficiency-in-grade-4}{%
\subsubsection{\texorpdfstring{\textbf{LEARNING OUTCOMES: \% LEARNING
POVERTY, 0\% GEPD PROFICIENCY IN GRADE
4}}{LEARNING OUTCOMES: \% LEARNING POVERTY, 0\% GEPD PROFICIENCY IN GRADE 4}}\label{learning-outcomes-learning-poverty-0-gepd-proficiency-in-grade-4}}

Learning poverty in Rwanda is than the average for Sub-Saharan Africa
(excluding high income) region and than the average for Low income
countries.

\hypertarget{figure-2.-leaning-poverty-comparison-rwanda}{%
\paragraph{Figure 2. Leaning poverty comparison,
Rwanda}\label{figure-2.-leaning-poverty-comparison-rwanda}}

\includegraphics[width=1\linewidth]{C:/Users/wb469649/OneDrive - WBG/Documents/Github/GEPD/Country_Reports/LP figures/lp_figure_RWA}

{\scriptsize
    \textcolor{darkgray}{\textit{Notes:} Grey circles represent other countries. Large yellow circle represents Rwanda. Other circles represent average learning poverty in Rwanda's region and income group.}
  }

\textbf{GEPD grade 4 assessment proficiency of 0\%} means 0\% students
score greater than 80/100 on student knowledge. Proficiency is 1 points
higher in literacy compared to numeracy, 0.1 points lower for boys
...
\includegraphics{C:/Users/wb469649/OneDrive - WBG/Documents/Github/GEPD/Country_Reports/Output/Rwanda_2020_2Pager_files/figure-latex/learning_figure-1.pdf}
