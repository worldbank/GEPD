...
Learning adjusted years of schooling (in years) & {\cellcolor{red!10}3.8} \\\cdashline{1-2}
Proficiency by End of Primary & {NA\%} \\\cdashline{1-2}
Proficiency on GEPD Assessment & {\cellcolor{red!10}0.2\%} \\\cdashline{1-2}
\hspace{1mm}\emph{Literacy proficiency} & {\cellcolor{red!10}0.6\%} \\\cdashline{1-2}
\hspace{1mm}\emph{Numeracy proficiency} & {\cellcolor{red!10}0.3\%} \\\cdashline{1-2}
Proficiency by Grade 2/3 & {NA\%} \\\cdashline{1-2}
Net Adjusted Enrollment Rate & {\cellcolor{green!10}95\%} \\\hline
\end{tabular}}
\\
...
\hspace{1mm}\emph{\% Socio-emotional skills}       & {NA\%} & \multirow{-2}{*}{Evaluation}              & \multirow{-2}{*}{\cellcolor{green!10}4.5} \\\cdashline{1-4}
...
Instructional Leadership                     & \cellcolor{yellow!10}3.4                   & \multirow{-2}{*}{Clarity of functions} & \multirow{-2}{*}{\cellcolor{green!10}4.9} \\\hline
                                             & \cellcolor{green!10}                    & Attraction                            & \cellcolor{green!10}4.3\\\cdashline{3-4}
\multirow{-2}{*}{Principal School knowledge}  & \multirow{-2}{*}{\cellcolor{green!10}4} & Selection \& Deployment               & \cellcolor{yellow!10}3.9\\\cdashline{3-4}
                                              & \cellcolor{green!10}                    & Support                               & \cellcolor{yellow!10}3.7\\\cdashline{3-4}
\multirow{-2}{*}{Principal Management skills}  & \multirow{-2}{*}{\cellcolor{green!10}4.2} & Evaluation                            & \cellcolor{green!10}4.5\\\hline
\end{tabular}}
\\
{\scriptsize
...
\resizebox{\columnwidth}{!}{\begin{tabular}{p{0.4\textwidth}c}
\textbf{Indicator} & \textbf{Value}\\ \hline
Quality of Bureaucracy & \cellcolor{green!10}4.4\\\cdashline{1-2}
Impartial Decision-Making & \cellcolor{yellow!10}3.7\\\cdashline{1-2}
Mandates \& Accountability & \cellcolor{green!10}4.5\\\cdashline{1-2}
National Learning Goals & \cellcolor{green!10}4.2\\\cdashline{1-2}
Financing & \cellcolor{red!10}2.4\\\hline
\end{tabular}}
\\
{\scriptsize
    \textcolor{darkgray}{\textit{Notes:} All scores are on a (0-5) scale.}
