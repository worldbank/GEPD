 ...
 input <- input %>%
   ...
   #Adding new cell with value and colour in new column
    mutate(value_color=case_when(
      ...
      (value >= lays_60 & value<lays_80 & (Series == "HD.HCI.LAYS")) ~ paste("\\cellcolor{yellow!15}",value, sep=""),
...
\tabindent\emph{\% Internet}          & {`r input$value_color[input$Series=="SE.PRM.INFR.5"]``r input$value_units[input$Series=="SE.PRM.INFR.5"]`} & & `r input$only_color[input$Series=="SE.PRM.IMON"]`\\\cdashline{1-2}
\tabindent\emph{\% Electricity}       & {`r input$value_color[input$Series=="SE.PRM.INFR.4"]``r input$value_units[input$Series=="SE.PRM.INFR.4"]`} & & `r input$only_color[input$Series=="SE.PRM.IMON"]`\\\cdashline{1-2}
