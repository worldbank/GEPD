...
`r lays_lp_choice` & {`r lays_lp_cell`} \\\cdashline{1-2}
Proficiency by End of Primary & {`r input$value_color[input$Series=="SE.LPV.PRIM.BMP"]`\%} \\\cdashline{1-2}
...
GEPD grade 4 assessment proficiency is defined as \% students scoring greater than 80/100 on student knowledge. **GEPD grade 4 assessment proficiency of `r grade4_overall`%** means `r grade4_overall`% students score greater than 80/100 on student knowledge. Student proficiency is `r lern_subject_text` in language compared to numeracy, `r lern_gender_text` for boys compared to girls, and `r lern_rururb_text` in urban areas compared to rural areas.  
