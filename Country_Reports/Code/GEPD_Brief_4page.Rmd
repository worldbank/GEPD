...
\cellcolor{practice} & \multirow{3}{2cm}{Teaching}                 & Teacher Presence           & {`r input$value_color[input$Series=="SE.PRM.EFFT"]``r input$value_units[input$Series=="SE.PRM.EFFT"]`} \\\cdashline{3-4}
...
\multirow{3}{*}{Teaching} & Teacher Presence      & {`r input$value_color[input$Series=="SE.PRM.EFFT.1.M"]`\%} & {`r input$value_color[input$Series=="SE.PRM.EFFT.1.F"]`\%} \\\cdashline{2-4}
...
\multirow{3}{*}{Teaching} & Teacher Presence                 & {`r input$value_color[input$Series=="SE.PRM.EFFT.1.R"]`\%} & {`r input$value_color[input$Series=="SE.PRM.EFFT.1.U"]`\%} \\\cdashline{2-4}
