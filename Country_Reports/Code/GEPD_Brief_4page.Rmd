...
GEPD grade 4 assessment proficiency is defined as \% students scoring greater than 80/100 on student knowledge. GEPD student proficiency in `r country` is `r grade4_overall`% . 
\vfill\null
Student proficiency in literacy is `r lern_subject_text` in literacy compared to numeracy, `r lern_gender_text` for boys compared to girls, and `r lern_rururb_text` in urban areas compared to rural areas.
