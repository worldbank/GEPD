...
\cellcolor{practice} & \multirow{3}{2cm}{Teaching}                 & Teacher Presence           & {`r input$value_color[input$Series=="SE.PRM.EFFT.2"]``r input$value_units[input$Series=="SE.PRM.EFFT"]`} \\\cdashline{3-4}
...
\cellcolor{policy}   & \multirow{5}{2cm}{Learners}                  & Nutrition Programs            & `r input$value_color[input$Series=="SE.PRM.LNTN"]` \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Health Programs               & `r input$value_color[input$Series=="SE.PRM.LHTH"]` \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Center based care             & `r input$value_color[input$Series=="SE.PRM.LCBC"]` \\\cdashline{3-4}
\cellcolor{policy}   &                                              & Caregiver Financial Capacity  & `r input$value_color[input$Series=="SE.PRM.LFCP"]` \\\cdashline{3-4}
...
\cellcolor{politics} & \multirow{5}{2cm}{Politics \& Bureaucratic Capacity}           & Quality of Bureaucracy & `r input$value_color[input$Series=="SE.PRM.BQBR"]` \\\cdashline{3-4}
\cellcolor{politics} & & Impartial Decision-Making  & `r input$value_color[input$Series=="SE.PRM.BIMP"]` \\\cdashline{3-4}
\cellcolor{politics} & & Mandates \& Accountability & `r input$value_color[input$Series=="SE.PRM.BMAC"]` \\\cdashline{3-4}
\cellcolor{politics} & & National Learning Goals    & `r input$value_color[input$Series=="SE.PRM.BNLG"]` \\\cdashline{3-4}
\cellcolor{politics}\multirow{-5}{*}{\rotatebox{90}{\textcolor{white}{Politics}}}     & & Financing            & `r input$value_color[input$Series=="SE.PRM.BFIN"]` \\\hline
\end{tabular}}
\\
...
\multirow{3}{*}{Teaching} & Teacher Presence      & {`r input$value_color[input$Series=="SE.PRM.EFFT.2.M"]`\%} & {`r input$value_color[input$Series=="SE.PRM.EFFT.2.F"]`\%} \\\cdashline{2-4}
...
\multirow{2}{*}{Learners}   & Capacity for Learning    & {`r input$value_color[input$Series=="SE.PRM.LCAP.M"]`\%} & {`r input$value_color[input$Series=="SE.PRM.LCAP.F"]`\%} \\\cdashline{2-4}
...
\multirow{3}{*}{Teaching} & Teacher Presence                 & {`r input$value_color[input$Series=="SE.PRM.EFFT.2.R"]`\%} & {`r input$value_color[input$Series=="SE.PRM.EFFT.2.U"]`\%} \\\cdashline{2-4}
...
\multirow{2}{*}{Learners}   & Capacity for Learning    & {`r input$value_color[input$Series=="SE.PRM.LCAP.R"]`\%} & {`r input$value_color[input$Series=="SE.PRM.LCAP.U"]`\%} \\\cdashline{2-4}
