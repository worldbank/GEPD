...
takeaway <- "
- Learning proficiency at the end of primary school is extremely low. GEPD assessment confirms this.
- Teachers’ content knowledge, readiness for learning, and basic infrastructure show most room for improvement.
- Student and teacher attendance is extremely low overall, and worse in urban settings than in rural ones. Whilst some may be due to the context of the data collection, the teacher monitoring system could be improved.
- Contrary to most countries, there does not seem to be a significant difference between rural and urban schools.
- At the policy level, teacher monitoring and teachers’ evaluation systems show the most room for improvement and enforcement. 
- At the bureaucratic level, public officials would benefit from having clearer targets and incentives aligned toward achieving them."
