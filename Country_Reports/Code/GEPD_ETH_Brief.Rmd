...
country_file_name <- "ETH"
country <- "Ethiopia"
country_year <- "2020 - 2021"



takeaway <- "
- Learning poverty is high largely due to low learning outcomes. GEPD assessment confirms this and shows rural schools lagging behind.
- Teaching skills, readiness for learning, and basic infrastructure show most room for improvement.
- There are large disparities in basic infrastructure and basic inputs between rural and urban schools, with rural schools lagging behind significantly.
- GEPD data signals COVID school disruptions have impacted teacher and student attendance, with girls being most affected.
- At the policy level, teacher and principal support systems show most room for improvement. 
- Bureaucratic capacity can be strengthened at the Woreda-level, which seems to lack incentives for good performance and training opportunities.
"
...
#load API file
input <- read_csv(paste("./Data/GEPD_Indicators_API_",country_file_name,"_pooled.csv",sep=""))

#load indicator desc
ind_desc <- read_csv(paste("./Data/GEPD_Indicators_Info.csv",sep=""))
...
source('./Code/Learning poverty_lays.R')
```
...
figure1a <- paste("C:/Users/wb577189/OneDrive - WBG/My files/Dashboard (Team Folder)/Main_Documents/Design/Images/full_circle.png", sep="")
 ...
 input <- input %>%
   ...
   #Adding new cell with value and colour in new column
    mutate(value_color=case_when(
      ...
      (value >= 90 &      (Series == "SE.LPV.PRIM")) ~ paste("#FF0000", sep=""),
      (value >=85 & value<90 & value<lays_90 & (Series == "SE.LPV.PRIM")) ~ paste("#FCD606", lays_units, sep=""),
      (value <85 &      (Series == "SE.LPV.PRIM")) ~ paste("#85C546", sep=""),
...
figure2 <- paste("C:/Users/wb577189/OneDrive - WBG/Documents/GitHub/GEPD/Country_Reports/LP_LAYS_figures/", figure, sep="")
...
#teacher linkages
link <- read_csv(paste("C:/Users/wb577189/OneDrive - WBG/Documents/GitHub/GEPD/Country_Reports/Data/",group,"_link.csv",sep=""),
                 trim_ws = FALSE)
...
#teacher linkages
link <- read_csv(paste("./Data/",group,"_link.csv",sep=""),
                 trim_ws = FALSE)
...
#teacher linkages
link <- read_csv(paste(here(),"/Data/",group,"_link.csv",sep=""),
                 trim_ws = FALSE)
...
#linkages
pol_link <- read_csv(paste(here(),"/Data/pol_link.csv",sep=""),
                 trim_ws = FALSE)
