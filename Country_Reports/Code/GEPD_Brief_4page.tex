...
\textbackslash{}resizebox\{\columnwidth\}\{!\}\{

\begin{tabular}{m{4cm}cm{4cm}c}
...
\} \textbackslash{} {\scriptsize \textbackslash{}end\{table\}
\raggedbottom
...
Management-Evaluation (1.4 points).
...
The highest score in politics and bureaucratic capacity is noted for
(4.7/5), and the lowest score is noted for (3.1/5).
