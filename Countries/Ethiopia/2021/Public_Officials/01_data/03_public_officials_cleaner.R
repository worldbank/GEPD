...
school_folder <- file.path(paste(project_folder,country,paste(country,year,"GEPD", sep="_"),paste(country,year,"GEPD_v02_RAW", sep="_"),"Data/confidential/School/", sep="/"))
  ...
  # sample_frame_name <- file.path(paste(project_folder,country,paste(country,year,"GEPD", sep="_"),paste(country,year,"GEPD_v02_RAW", sep="_"),"Data/sampling/", paste0("school_sample_",currentDate,".RData"), sep="/"))
  # 
...
preamble_info <- c('interview__id', 'interview__key', 'office_preload', 'govt_tier','Region', 'Zone','Woreda',
