---
title: "Global Education Policy Dashboard - Ethiopia 2020/2021 Pooled"
...
Roadmap:  
- Below is a set of tables and charts containing findings for the Ethiopia 2020/21 Pooled Global Education Policy Dashboard survey. - We will start with breakdowns of our Practice indicators  
...
#set directory to bring in data
 ...
 if(Sys.info()["user"] == "wb577189"){
    ...
    work_dir<- "C:/Users/wb577189/OneDrive - WBG/GEPD/CNT/ETH/ETH_2021_GEPD/ETH_2021_GEPD_v01_M/Data/"


    
  } else if (str_to_lower(Sys.info()["user"]) == "wb469649") {
    
work_dir<- "C:/Users/wb469649/WBG/HEDGE Files - HEDGE Documents/GEPD/CNT/ETH/ETH_2021_GEPD/ETH_2021_GEPD_v01_M/Data/"

    
  } else if (str_to_lower(Sys.info()["user"]) == "wb631589") {
    
work_dir<- "C:/Users/wb631589/OneDrive - WBG/GEPD/CNT/ETH/ETH_2021_GEPD/ETH_2021_GEPD_v02_M/Data/"
}
...
#set directory to bring in data
 ...
 if(Sys.info()["user"] == "wb577189"){
    ...
    data_dir_2020<- "C:/Users/wb577189/OneDrive - WBG/GEPD/CNT/ETH/ETH_2020_GEPD/ETH_2020_GEPD_v01_M/Data/"
...
data_dir_2020_confidential <- "C:/Users/wb631589/OneDrive - WBG/GEPD-Confidential/CNT/ETH/ETH_2020_GEPD/ETH_2020_GEPD_v02_RAW/Data/confidential"
work_dir_confidential <- "C:/Users/wb631589/OneDrive - WBG/GEPD-Confidential/CNT/ETH/ETH_2021_GEPD/ETH_2021_GEPD_v02_RAW/Data/confidential"


}

#attach saved results for 2020
load(paste0(data_dir_2020, "/School/school_indicators_data_anon.Rdata"))
...
save(list = frames_2021,
  file = "C:/Users/wb577189/OneDrive - WBG/GEPD/CNT/ETH/ETH_2020_2021_GEPD/ETH_2020_2021_GEPD_v01_M/Data/School/school_indicators_data_anon.Rdata")

    
  } else if (str_to_lower(Sys.info()["user"]) == "wb469649") {
    
save(list = frames_2021,
  file = "C:/Users/wb469649/WBG/HEDGE Files - HEDGE Documents/GEPD/CNT/ETH/ETH_2020_2021_GEPD/ETH_2020_2021_GEPD_v01_M/Data/School/school_indicators_data_anon.Rdata")
    
  } else if (str_to_lower(Sys.info()["user"]) == "wb631589") {

save(list = frames_2021,
  file = "C:/Users/wb631589/OneDrive - WBG/GEPD/CNT/ETH/ETH_2020_2021_GEPD/ETH_2020_2021_GEPD_v02_M/Data/School/school_indicators_data_anon.Rdata")
    
}

########################################
#added by VF -- do the same thing but for the data that has not been anon yet
rm(list = ls())

if (str_to_lower(Sys.info()["user"]) == "wb631589") {
...
load(paste(work_dir_confidential, "School/school_indicators_data.RData", sep=""))


#get list of data frames and add _2021 as suffix
frames_2021_confidential <- names(which(unlist(eapply(.GlobalEnv,is.data.frame))))

for (x in frames_2021_confidential) {
...
#load public official data
load(paste(work_dir_confidential, "Public_Officials/public_officials_indicators_data.RData", sep=""))
...
#attach saved results for 2020
load(paste0(data_dir_2020_confidential, "/School/school_indicators_data.Rdata"))
...
save(list = frames_2021_confidential,
  file = "C:/Users/wb631589/OneDrive - WBG/GEPD-Confidential/CNT/ETH/ETH_2020_2021_GEPD/ETH_2020_2021_GEPD_v02_RAW/Data/confidential/School/school_indicators_data.Rdata")
...
#load("C:/Users/wb577189/OneDrive - WBG/GEPD-Confidential/CNT/ETH/ETH_2020_2021_GEPD/ETH_2020_2021_GEPD_v01_RAW/Data/confidential/School/school_survey_data.Rdata")
load("C:/Users/wb631589/OneDrive - WBG/GEPD-Confidential/CNT/ETH/ETH_2020_2021_GEPD/ETH_2020_2021_GEPD_v02_RAW/Data/confidential/School/school_survey_data.Rdata")

## Get the teacher gender
teach_gender <- teacher_roster %>% select(1:7, starts_with("school")) %>% 
  rename(m4saq1_number = TEACHERS__id,
         m4saq1 = m2saq2) %>% select(-w1, -w2)


teacher_teach <- school_dta %>% select(school_code, m4saq1_number) %>% filter(!is.na(m4saq1_number)) 

teach_gender_bis <- teach_gender %>% select(school_code, interview__key, m2saq3, m4saq1_number) %>% rename(interview_key=interview__key) %>% right_join(teacher_teach, by = c("school_code", "m4saq1_number"))

teach_ipw <- school_dta_raw_anon %>%  select(interview__key, ipw) %>% rename(interview_key = interview__key)

teach_gender_bis <- teach_gender_bis %>% left_join(teach_ipw, by=c("interview_key"))



final_TEACH_gender <- teach_gender_bis %>% left_join(final_indicator_data_PEDG) %>% distinct() %>% filter(!is.na(Segment))%>%  mutate(above_min = if_else(teach_score >= 3, 1, 0))%>% rename(sch_ipw= ipw)


final_TEACH_gender_w <- final_TEACH_gender %>% group_by(m2saq3) %>% summarise(pedagogical = wtd.mean(above_min, w=sch_ipw, na.rm=TRUE))
    
    final_TEACH_gender_non_w <- final_TEACH_gender %>% group_by(m2saq3) %>% summarise(pedagogical = wtd.mean(above_min, na.rm = T))
...
# School Survey
  ...
  sumstats_df %>%
    ...
    kable(caption = "Summary Statistics of Dashboard Indicators - Ethiopia 2020/21 Pooled - Urban/Rural",
...
#public/private
  ...
  sumstats_df %>%
    ...
    kable(caption = "Summary Statistics of Dashboard Indicators - Ethiopia 2020/21 Pooled - Public/Private Schools",
          col.names = c("Indicator", "Mean", "95% Confident Interval", "Mean", "95% Confident Interval"
...
region_content_plot <- region_content %>%
  ...
  ggplot(aes(x=content_knowledge, y=Type))  +
    geom_density_ridges(aes(fill=Type , weight=weight), alpha=0.6, trim = TRUE) +
...
main_indicator_labels<-c( 
  ...
  expert_dir<- "C:/Users/wb577189/OneDrive - WBG/My files/Dashboard (Team Folder)/Country_Work/Ethiopia/2021/Data/clean/Policy_Survey"
        ...
        expert_dir <- "//wbgfscifs01/GEDEDU/datalib-edu/projects/GEPD/CNT//ETH/ETH_2020_GEPD/ETH_2020_GEPD_v01_M/Data/Expert_Survey"
