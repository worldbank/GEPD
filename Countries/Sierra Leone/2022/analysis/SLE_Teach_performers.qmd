---
title: "GEPD SLE Teach High/Low Performers"
author: "GEPD Team"
execute:
  echo: false
  warning: false
...
teacher_pedagogy_micro <- df_weights_function(final_indicator_data_PEDG, school_code, class4_combined, idregion)                    


subind <- teacher_pedagogy_micro %>%
  select(school_code,c("SUBJECT",     "GRADE",       "Enumerator",  "Segment"), starts_with("s_"), c(
    "classroom_culture","instruction","socio_emotional_skills",
                   "teach_score", "teach_prof", "classroom_culture_prof",
                   "instruction_prof", "socio_emotional_skills_prof", 
                   "sch_owner", "idregion","iddistrict","accessibility",
                   "school_districthq_distance","urban_rural","private","ipw","province"))

labels=c('School Code',"SUBJECT",     "GRADE",       "Enumerator",  "Segment",
         teach_labels$label,
                   "Teach Classroom Culture Score (1-5 scale)","Teach Instruction Score (1-5 scale)","Teach Socio-emotional Skills Score (1-5 scale)",
                   "Teach Score (1-5 scale)", "Percentage of Teachers Proficient in Pedagogy", "Percentage of Teachers Proficient in Classroom Culture",
                   "Percentage of Teachers Proficient on Instruction", "Percentage of Teachers Proficient in Socio-emotional Skills", 
                   "sch_owner", "idregion","iddistrict","accessibility",
                   "school_districthq_distance","urban_rural","private","ipw","province"
         
         )
names(labels) <- c('school_code', "SUBJECT",     "GRADE",       "Enumerator",  "Segment", teach_labels$variable,
                   "classroom_culture","instruction","socio_emotional_skills",
                   "teach_score", "teach_prof", "classroom_culture_prof",
                   "instruction_prof", "socio_emotional_skills_prof", 
                   "sch_owner", "idregion","iddistrict","accessibility",
...
write_dta(subind, path = paste0(confidential_folder, "/teacher_pedagogy_micro","_",country,"_",year,".dta"))    
