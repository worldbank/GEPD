...
#############################################
  ...
  # For salary, based GDP per capita from 2020 World Bank  https://data.worldbank.org/indicator/NY.GDP.PCAP.PP.CD?locations=SL.  
  
  school_data_SATT <- school_data_SATT %>%
    mutate(principal_satisfaction=attitude_fun_rev(m7shq1_satt),
           principal_salary=if_else(m7shq2_satt==999, as.numeric(NA),12*m7shq2_satt/5661845	)) %>%
    mutate(
