...
if (Sys.getenv("USERNAME") == "wb469649"){
  ...
  download_folder <-file.path(paste(project_folder,country_name,year,"Data/school_survey/rollout", sep="/"))
  save_folder <- file.path(paste(project_folder,country_name,year,"Data/school_survey/rollout", sep="/"))
