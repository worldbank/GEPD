...
if (quest_version==6) {
  unzip(file.path(download_folder, file_name), exdir=paste(download_folder,'version_6', sep="/"))
...
school_dta <-  bind_rows(
    read_dta(file.path(download_folder, "EPDash_7_STATA_All/EPDash.dta")),
    read_dta(file.path(download_folder, "EPDash_8_STATA_All/EPDash.dta"))         
             )
...
ecd_dta<-bind_rows(
  read_dta(file.path(download_folder, "EPDash_7_STATA_All/ecd_assessment.dta")),
  read_dta(file.path(download_folder, "EPDash_8_STATA_All/ecd_assessment.dta"))         
)
  #Add in ecd metadata
...
assess_4th_grade_dta<-bind_rows(
  read_dta(file.path(download_folder, "EPDash_7_STATA_All/fourth_grade_assessment.dta")),
  read_dta(file.path(download_folder, "EPDash_8_STATA_All/fourth_grade_assessment.dta"))         
)
...
teacher_questionnaire <- bind_rows(
  read_dta(file.path(download_folder, "EPDash_7_STATA_All/questionnaire_roster.dta")),
  read_dta(file.path(download_folder, "EPDash_8_STATA_All/questionnaire_roster.dta"))         
)
...
teacher_absence_dta<-bind_rows(
  read_dta(file.path(download_folder, "EPDash_7_STATA_All/TEACHERS.dta")),
  read_dta(file.path(download_folder, "EPDash_8_STATA_All/TEACHERS.dta"))         
)
...
teacher_assessment_dta<-bind_rows(
  read_dta(file.path(download_folder, "EPDash_7_STATA_All/teacher_assessment_answers.dta")),
  read_dta(file.path(download_folder, "EPDash_8_STATA_All/teacher_assessment_answers.dta"))         
)
