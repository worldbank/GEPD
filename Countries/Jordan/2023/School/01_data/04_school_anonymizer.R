...
#read in 2019 key
key_2019 <- read_csv(file.path(confidential_folder, "EPDash_linkfile_hashed_2019.csv")) %>%
  rename(
    hashed_school_code_2019=hashed_school_code
  ) %>%
  select(school_code, hashed_school_code_2019)
