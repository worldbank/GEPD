...
#read in public officials interview file
public_officials_dta_7<-read_dta(file.path(paste(download_folder,"public_officials_3_STATA_All", sep="/"), "public_officials.dta")) 

public_officials_dta<-read_dta(file.path(paste(download_folder,"public_officials_4_STATA_All", sep="/"), "public_officials.dta")) 
