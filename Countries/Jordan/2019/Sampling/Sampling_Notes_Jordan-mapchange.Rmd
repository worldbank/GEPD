...
```{r stats_kable, eval=FALSE, include=FALSE}
...
map3 <- function(df_input) {    leaflet(df_input) %>% 
...
map4 <- function(df_input) {    leaflet(df_input) %>% 
...
```{r country_map2, echo=FALSE, out.height=8, out.width=9}
...
map3(sample_map_chosen)

map4(sample_map_chosen)
