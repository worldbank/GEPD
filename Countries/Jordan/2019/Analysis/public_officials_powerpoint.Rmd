...
#set directory to bring in data
 if (str_to_lower(Sys.getenv("USERNAME")) == "wb577189"){
    ...
    work_dir  <- "C:/Users/wb577189/OneDrive - WBG/CNT/JOR/JOR_2019_GEPD/JOR_2019_GEPD_v01_RAW/Data/confidential/"
...
```{r datatable, echo=FALSE}
 #add in custom column sub-headers
  ...
  DT::datatable(sumstats_df, 
                caption="Summary Statistics of Dashboard Indicators - Jordan 2019",
                container = sketch,
                rownames=FALSE,
...
```{r datatable2, echo=FALSE}
 #add in custom column sub-headers
  ...
  DT::datatable(sumstats_df2, caption="Summary Statistics of Dashboard Indicators - Jordan 2019",
                container = sketch,
                rownames=FALSE,
                class='cell-border stripe',
                escape = FALSE,
