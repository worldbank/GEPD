---
title: "Item Analysis of GEPD 4th Grade Knowledge Module - Jordan"
author: Brian Stacy
date: "`r Sys.Date()`"
output:
  html_document: 
...
assess_4th_grade_weights <- assess_4th_grade_anon %>%
  ...
  select(colnames(assess_4th_grade_anon), school_ipw, total_sampled, governorate)
...
lang_cutscores <- data.frame(lang2, num_correct, school_ipw)
...
math_cutscores <- data.frame(math2, num_correct, school_ipw)
