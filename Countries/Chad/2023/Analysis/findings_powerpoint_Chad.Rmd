...
#build table
tab_df <- tab_df  %>%
  select(`Indicator Name`,`Chad`, Peru, Jordan, Rwanda, Ethiopia, Madagascar)
...
svymeantab <- function(data, strata) {
  ...
  get(data) %>%
    ...
    select(one_of(indicators_list), Region, urban_rural, ipw ) %>%
...
# School Survey
    ...
    sumstats_school_df <- svymeantab('sumstats_school', strata=c('Region'))
    ...
    sumstats_school_urban_df <- svymeantab('sumstats_school_urban', strata=c('Region'))
    ...
    #rural
      ...
      sumstats_school_rural_df <- svymeantab('sumstats_school_rural', strata=c('Region'))
  ...
  sumstats_df %>%
    ...
    kable(caption = "Summary Statistics of Dashboard Indicators - Chad 2023 - Urban/Rural",
...
#public/private
      ...
      #add variable label
      sumstats_school_nonprivate_df <-  svymeantab('sumstats_school_nonprivate', strata=c('Region')) %>%
        rename(
          mean_urban=mean,
          ci_urban=ci
        )
      ...
      #add variable label
      sumstats_school_private_df <-  svymeantab('sumstats_school_private', strata=c('Region')) %>%
        rename(
          mean_rural=mean,
          ci_rural=ci
        )
  ...
  sumstats_df %>%
    ...
    kable(caption = "Summary Statistics of Dashboard Indicators - Chad 2023 - Public/Private Schools",
          col.names = c("Indicator", "Mean", "95% Confident Interval", "Mean", "95% Confident Interval"
