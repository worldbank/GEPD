...
if (need_api==1) {
  ...
  server_add<- svDialogs::dlgInput("Please Enter Server http Address:", 'http://etri.gepd.solutions/gepdchd')$res
  ...
  json_body <- jsonlite::toJSON(list(
    ExportType= "Paradata",
    QuestionnaireId= paste0("187444ba78d14baba2f9211130689fd2$", quest_version),
    From="",
    To="",
    AccessToken="",
    RefreshToken="",
