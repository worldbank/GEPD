...
skim_with_defaults()
load(file=paste(confidential_folder, "paradata.RData", sep="/"))
```
...
load(paste(confidential_folder, "public_officials_survey_data.RData", sep="/"))
...
write_excel_csv(sumstats_df, paste(confidential_folder,'GEPD_Public_Officials_Indicators.csv',sep=""))
```
