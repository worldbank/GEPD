...
## Set directory
setwd("C:/Users/wb577189/OneDrive - WBG/My files/Dashboard (Team Folder)/Country_Work/Gabon/2023/Data/school_survey/rollout/raw/")
...
lapply(seq_along(lst1), function(i) write_dta(lst1[[i]], paste("C:/Users/wb577189/OneDrive - WBG/GEPD-Confidential/CNT/GAB/GAB_2023_GEPD/GAB_2023_GEPD_v01_RAW/Data/raw/School", 
                                                               names(lst1)[i], sep = "/")))
