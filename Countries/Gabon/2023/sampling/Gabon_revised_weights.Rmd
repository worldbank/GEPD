...
if (str_to_lower(Sys.getenv("USERNAME")) == "wb469649" ){
  ...
  confidential_folder <- file.path(paste('C:/Users/wb469649/WBG/HEDGE Files - HEDGE Documents/GEPD-Confidential/CNT/',country,paste(country,year,"GEPD", sep="_"),paste(country,year,"GEPD_v02_RAW", sep="_"),"Data/confidential/School", sep="/"))
