...
indicators <- read_csv('C:/Users/wb577189/OneDrive - WBG/Documents/GitHub/GEPD/Indicators/indicators.csv')
...
school_data_INPT <- school_data_INPT %>%
  mutate(used_ict_num=case_when(
    m1sbq12_inpt==0  ~ 0,
      (m1sbq12_inpt>=1 ) ~ m1sbq15_inpt,
      (is.na(m1sbq12_inpt==0) | is.na(m1sbq15_inpt)) ~ as.numeric(NA)
  ))
...
data_list <- c(ind_dta_list, 'school_dta', 'school_dta_short', 
               ...
               'final_school_data', 'teacher_questionnaire','teacher_absence_final', 'ecd_dta', 'teacher_assessment_dta', 'teacher_roster', 
               "indicators", 'metadta', 
               #'school_gdp', 
