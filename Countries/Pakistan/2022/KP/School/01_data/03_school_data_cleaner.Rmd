...
```{r echo=FALSE}
 ...
 #############################################
  ...
  var.labels = c(school_code="Video Name/New school ID",
                 ...
                 s_a1_4a = "1.4 The teacher does not exhibit gender bias and challenges gender stereotypes in the classroom",
                 s_a1_4b = "1.4 The teacher does not exhibit disability bias and challenges disability stereotypes in the classroom",
...
#open the raster
raster_folder <- file.path(paste(project_folder,country,paste(country,year,"GEPD", sep="_"),paste(country,year,"GEPD_v02_RAW", sep="_"),"Data/",province,"/Maps/GDP", sep="/")) 
