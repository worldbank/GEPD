            ...
            tabsetPanel(type = "tabs",
                        ...
                        tabPanel("Multivariate Regression Tool", value=7, 
                                 p('This tool allows the user to produce multivaratie OLS regression tables by selecting an outcome variable along with 
                                   ...
                                   the user has the option to include regional fixed effects.  In the case of Pakistan - KP, these are Pakistan - KP District fixed effects.'),
...
output$indicators_table <- DT::renderDataTable({
  ...
  DT::datatable(sumstats_df, caption="Summary Statistics of Dashboard Indicators - Pakistan - KP 2022",
