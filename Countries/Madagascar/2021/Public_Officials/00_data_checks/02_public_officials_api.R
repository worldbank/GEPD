...
# questID <- "5534a374fa8434bb7d6f5133cdebab2"
# #user credentials
...
# POST(url=paste(server_add,"/api/v1/export/STATA/",questID, "$",quest_version, sep=""),
#          authenticate(user, password, type = "basic"))
# 
# #sleep for 10 seconds to wait for stata file to compile
# Sys.sleep(10)
# 
# dataDownload <- GET(paste(server_add,"/api/v1/export/stata/5534a374fa8434bb7d6f5133cdebab2$", quest_version,"/",approval,sep=""),
#                     authenticate(user, password))
# 
