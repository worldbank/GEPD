...
combined_df_raw <- bind_rows(PER_data,JOR_data, ETH_data,  MDG_data)
...
ggplot() +
  ...
  labs(
    ...
    subtitle = 'GEPD Student and Teacher Practice Outcomes in Peru, Jordan, Ethiopia, and Madagascar',
...
combined_school_office_df <- bind_rows(PER_school_office_link_df, JOR_school_office_link_df, ETH_school_office_link_df, MDG_school_office_link_df) 
