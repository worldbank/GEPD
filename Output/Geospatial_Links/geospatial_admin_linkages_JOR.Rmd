...
main_po_data <- main_po_data %>%
  mutate(po_survey_length=case_when(
    ENUMq1<20 ~ "under 20 min",
    between(ENUMq1, 20,60) ~ "20-60 min",
    ENUMq1>60 ~ "Over 60 min"
  )) %>%
  # get hour of survey
...
write_excel_csv(linked_school_data_csv, paste0(shared_folder, country,"_",year,"/linked_po_school_data_",country,"_",year,".csv"))
...
write_excel_csv(linked_school_data_csv, paste0(shared_folder,country,"_",year,"/linked_po_directors_school_data_",country,"_",year,".csv"))
...
write_excel_csv(linked_school_data_csv, paste0(shared_folder,country,"_",year,"/linked_po_enum_score_weighted_school_data_",country,"_",year,".csv"))
