...
#Jordan
JOR_weights <- read_dta(paste0(file.path(paste(project_folder,"CNT","JOR",paste("JOR",'2019',"GEPD", sep="_"),paste("JOR",'2019',"GEPD_v01_RAW", sep="_"),"Data/anonymized/School/data", sep="/")), "/school_weights_anon.dta")) %>%
  mutate(iso3c="JOR",
         date=2019)
