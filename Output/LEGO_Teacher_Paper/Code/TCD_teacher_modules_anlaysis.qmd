...
teacher_pedagogy_g2 <- school_micro_raw %>%
  select(preamble_info, starts_with('m9saq1'), ends_with('_g2') ) 

  
#add weights and anonymize
teacher_pedagogy_micro_g2 <- df_add_weights('teacher_pedagogy_g2') %>%
  select(-starts_with('interview__')) 
