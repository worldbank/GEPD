...
if (str_to_lower(Sys.getenv("USERNAME")) == "wb469649" ){
  ...
  download_folder <-file.path(paste(project_folder,"CNT",country,paste(country,year,"GEPD", sep="_"),paste(country,year,"GEPD_v01_RAW", sep="_"),"Data/raw/School/INFRA/", sep="/"))
...
# teacher_assessment_dta_raw <- read_dta(file.path(download_folder, "teacher_assessment_answers_Clean.dta")) %>%
#   select(-c("school_name_preload", "school_province_preload", "school_district_preload", "school_emis_preload", "m1s0q2_name", "m1s0q2_code", "m1s0q2_emis", "school_code")) %>%
#   left_join(school_data_preamble) %>%
#   select(preamble_info, everything()) 
# 
...
# 
# teacher_pedagogy_micro <- teacher_pedagogy_micro %>%
#   left_join(teacher_assessment_weights, by = "school_code")
