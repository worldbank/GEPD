...
# #Add school preamble info# teacher_absence_dta <- teacher_absence_dta %>%
#   left_join(school_data_preamble) %>%
#   select(preamble_info, everything()) 
...
teach_labels <- read_csv("C:/Users/wb631589/OneDrive - WBG/GEPD-Confidential/General/Country_Data/SLE/Code/analysis/Teach_labels.csv") 
...
matches <- teacher_combined_df %>%
  select(school_code, TEACHERS__id, teacher_name, m5sb_tnum, m5sb_troster, m3sb_tnumber, m3sb_troster,m4saq1_number, m4saq1, m4saq1_number_g2, m4saq1_g2, pedagogy_id)
