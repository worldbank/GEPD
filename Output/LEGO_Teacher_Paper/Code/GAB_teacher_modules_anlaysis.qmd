...
if (str_to_lower(Sys.getenv("USERNAME")) == "wb469649" ){
  ...
  save_input_folder <- file.path(paste0('C:/Users/wb469649/WBG/HEDGE Files - HEDGE Documents/GEPD-Confidential/',"General/LEGO_Teacher_Paper/3_input_data"))
  save_output_folder <- file.path(paste0('C:/Users/wb469649/WBG/HEDGE Files - HEDGE Documents/GEPD-Confidential/',"General/LEGO_Teacher_Paper/5_output_data"))
...
key <- read_csv("C:/Users/wb631589/OneDrive - WBG/GEPD-Confidential/CNT//GAB//GAB_2023_GEPD//GAB_2023_GEPD_v02_RAW/Data/confidential/School/EPDash_linkfile_hashed.csv")
...
sample_folder <- file.path(paste(project_folder, "/CNT/", country,paste(country,year,"GEPD", sep="_"),paste(country,year,"GEPD_v02_RAW", sep="_"),"Data/sampling/", sep="/"))
...
# school_dta$hashed_school_code <-as.character(lapply(school_dta$school_code, function(x) {digest(x, algo="xxhash64", seed=531254, serialize = F)}))
# school_dta$hashed_school_province <-as.character(lapply(school_dta$school_province_preload, function(x) {digest(x, algo="xxhash64", seed=531254, serialize = F)}))
# school_dta$hashed_school_district <-as.character(lapply(school_dta$school_district_preload, function(x) {digest(x, algo="xxhash64", seed=531254, serialize = F)}))
# 
# 
#   
