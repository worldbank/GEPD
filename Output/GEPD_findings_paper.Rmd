...
The table above highlights the low levels of learning seen in children in 4th grade in even middle income countries such as Peru and Jordan.  The Low income countries (Rwanda, Ethiopia, and Madagascar) fare even worse.

The figure breaks down the 4th Grade Learning Assessment scores, highlighting specific items.
...
indicators <- c("m8saq2_id", "m8saq5_story", "m8sbq3a_arithmetic", "m8sbq3f_arithmetic")
indicator_desc <- c("Identify Three Letters", "Answer Story Question", "8+7", "7x8")
