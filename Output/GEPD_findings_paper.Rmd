...
2. Caution - Values between 80-90  
3. Needs Improvement - Values under 80%  
...
In the tables below, indicators shared in green are "On Target", indicators shared in yellow are "Caution", and indicators shaed in red are "Needs Improvement".
...
modelsummary(models,
             ...
             gof_map = gm,
             notes="Regressions also include log GDP within 1km of school, urban rural status, and total school enrollment as covariates.",
             escape = FALSE
             )
```
