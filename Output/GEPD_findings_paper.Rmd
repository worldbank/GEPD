...
# policy_colours <- combined_wide_color %>% filter(str_detect(`Indicator Name`, "De Jure"))
# 
# policy_score <- combined_wide_df%>% filter(str_detect(`Indicator Name`, "De Jure"))

# read in the microdata for Policy surveys
