...
In Peru, only a little over 60% of students met this proficiency level, and in Madagascar, the number was only around 5%.  
...
combined_g1_mn <- combined_g1_mn %>%
  ...
  mutate(Domain=factor(Domain, labels=indicator_desc))
