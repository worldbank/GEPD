...
'Availability of Basic Inputs' = feols(inputs ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Availability of Functional Blackboard' = feols(blackboard_functional ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Availability of Writing Utencils' = feols(pens_etc ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Availability of Textbooks' = feols(textbooks ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Availability of Desks' = feols(share_desk ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Availability of ICT' = feols(access_ict ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero')
...
modelsummary(models,
             ...
             coef_rename = c("presence_rate"  = "Teacher Presence",
                             ...
                             "principal_knowledge_score" = "Principal Knowledge",
                             "principal_management" = "Principal Management",
                             'factor(students_enrolled)150-300' = "Students enrolled: 150-300",
                             'factor(students_enrolled)25-50' = "Students enrolled: 25-50",
                             'factor(students_enrolled)300-500' = "Students enrolled: 300-500",
                             'factor(students_enrolled)50-75' = "Students enrolled: 50-75",
                             'factor(students_enrolled)75-100' = "Students enrolled: 75-100",
                             'factor(students_enrolled)Over 500' = "Students enrolled: Over 500",
                             'factor(students_enrolled)Under 25' = "Students enrolled: Under 25",
                             'factor(country)Ethiopia' = "Ethiopia",
                             'factor(country)Gabon' = "Gabon",
                             'factor(country)Jordan-2019' = "Jordan 2019",
                             'factor(country)Jordan-2023' = "Jordan 2023",
                             'factor(country)Madagascar' = "Madagascar",
                             'factor(country)Niger' = "Niger",
                             'factor(country)Pakistan-ICT' = "Pakistan - ICT",
                             'factor(country)Pakistan-KP' = "Pakistan - KP",
                             'factor(country)Peru' = "Peru",
                             'factor(country)Rwanda' = "Rwanda", 
                             'factor(country)Sierra Leone' = "Sierra Leone"),
...
'Availability of Basic Infrastructure' = feols(infrastructure ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Availability of Drinking Water' = feols(drinking_water ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Availability of Functional Toilet' = feols(functioning_toilet ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Availability of internet' = feols(internet ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Availability of Electricity' = feols(class_electricity ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Access for the Disabled' = feols(disability_accessibility ~   operational_management    + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero')
...
'4th Grade Math Score' = feols(math_student_knowledge ~  presence_rate + content_knowledge  + inputs + infrastructure + ecd_student_knowledge  + operational_management + instructional_leadership + principal_knowledge_score + principal_management  + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero')
)
...
'4th Grade Student Knowledge - Peru' = feols(student_knowledge ~  presence_rate + content_knowledge + teach_score + inputs + infrastructure + ecd_student_knowledge + student_attendance + operational_management + instructional_leadership + principal_knowledge_score + principal_management   + rural + factor(students_enrolled), data=PER_school_office_link_df,vcov='hetero'),

'4th Grade Student Knowledge - Jordan' = feols(student_knowledge ~  presence_rate + content_knowledge + teach_score + inputs + infrastructure + ecd_student_knowledge + student_attendance + operational_management + instructional_leadership + principal_knowledge_score + principal_management   + rural + factor(students_enrolled), data=JOR_school_office_link_df,vcov='hetero'),

'4th Grade Student Knowledge - Rwanda' = feols(student_knowledge ~  presence_rate + content_knowledge + teach_score + inputs + infrastructure + ecd_student_knowledge + student_attendance + operational_management + instructional_leadership + principal_knowledge_score + principal_management  + rural + factor(students_enrolled), data=RWA_school_office_link_df,vcov='hetero'),

'4th Grade Student Knowledge - Ethiopia' = feols(student_knowledge ~ presence_rate + content_knowledge + teach_score + inputs + infrastructure + ecd_student_knowledge + student_attendance + operational_management + instructional_leadership + principal_knowledge_score + principal_management   + rural + factor(students_enrolled), data=ETH_school_office_link_df,vcov='hetero'),

'4th Grade Student Knowledge - Madagascar' = feols(student_knowledge ~  presence_rate + content_knowledge  + inputs + infrastructure + ecd_student_knowledge + operational_management + instructional_leadership + principal_knowledge_score + principal_management   + rural + factor(students_enrolled), data=MDG_school_office_link_df,vcov='hetero')
)
...
reg_fun <- function(indicators) {
  ...
  form <- as.formula(paste0(paste(out, paste(cov, collapse=" + "), sep=" ~ "),"   + rural + factor(students_enrolled) + factor(country)"))
  
  
  estimatr::lm_robust(form, data=combined_school_office_df,se_type='HC2')
  
  models <-  estimatr::lm_robust(form, data=combined_school_office_df,se_type='HC2')



  modelsummary(models,
               estimate= "{estimate}{stars}",
               coef_rename = c(cov_lab,
                             'factor(students_enrolled)150-300' = "Students enrolled: 150-300",
                             'factor(students_enrolled)25-50' = "Students enrolled: 25-50",
                             'factor(students_enrolled)300-500' = "Students enrolled: 300-500",
                             'factor(students_enrolled)50-75' = "Students enrolled: 50-75",
...
```{r pedgcontplt, eval=FALSE, cache=TRUE, include=FALSE}
...
```{r echo=FALSE}
 ...
 breaking_up_all_teacher <- combined_teachers_df %>%
    mutate_at(c(2:length(.)), ~ as.numeric(.)) %>% 
    mutate(
       m3bq10_tmna =if_else(m3bq10_tmna_7 ==1, 0, 1),
       m3sbq9_tmna =if_else(m3sbq9_tmna_7 ==1, 0, 1)
 ...
 breaking_up_teacher <- combined_teachers_df %>%
    relocate(iso3c) %>% 
    mutate_at(c(2:length(.)), ~ as.numeric(.)) %>% 
    mutate(
       m3bq10_tmna =if_else(m3bq10_tmna_7 ==1, 0, 1),
...
'4th Grade Student Knowledge' = feols(student_knowledge ~  bureau_index  + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Teacher Presence' =  feols(presence_rate ~   bureau_index   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'Teacher Pedagogy' =  feols(teach_score ~   bureau_index  + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'School Inputs' =  feols(inputs ~   bureau_index  + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'School Infrastructure' =  feols(infrastructure ~   bureau_index  + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'Operations Management' =  feols(operational_management ~  bureau_index   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'Principal Management Skills' =  feols(principal_management ~  bureau_index   + rural + factor(students_enrolled)   | country, data=combined_school_office_df,vcov='hetero')
...
'4th Grade Student Knowledge' = feols(student_knowledge ~  bureau_index:country  + rural + factor(students_enrolled) | country, data=combined_school_office_df,vcov='hetero'),

'Teacher Presence' =  feols(presence_rate ~   bureau_index:country   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'Teacher Pedagogy' =  feols(teach_score ~   bureau_index:country  + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'School Inputs' =  feols(inputs ~   bureau_index:country  + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'School Infrastructure' =  feols(infrastructure ~   bureau_index:country  + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'Operations Management' =  feols(operational_management ~  bureau_index:country   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'Principal Management Skills' =  feols(principal_management ~  bureau_index:country   + rural + factor(students_enrolled)   | country, data=combined_school_office_df,vcov='hetero')
...
'Student Knowledge' = feols(student_knowledge ~ quality_bureaucracy + national_learning_goals + impartial_decision_making + mandates_accountability   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'Teacher Presence' =  feols(presence_rate ~ quality_bureaucracy + national_learning_goals + impartial_decision_making + mandates_accountability   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'Teacher Pedagogy' =  feols(teach_score ~ quality_bureaucracy + national_learning_goals + impartial_decision_making + mandates_accountability   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'School Inputs' =  feols(inputs ~ quality_bureaucracy + national_learning_goals + impartial_decision_making + mandates_accountability   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'School Infrastructure' =  feols(infrastructure ~ quality_bureaucracy + national_learning_goals + impartial_decision_making + mandates_accountability   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'Operations Management' =  feols(operational_management ~ quality_bureaucracy + national_learning_goals + impartial_decision_making + mandates_accountability   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero'),

'Principal Management Skills' =  feols(principal_management ~ quality_bureaucracy + national_learning_goals + impartial_decision_making + mandates_accountability   + rural + factor(students_enrolled)  | country, data=combined_school_office_df,vcov='hetero')
...
```{r anova}
#set controls
controls <- ' rural + factor(students_enrolled) + factor(country)'
