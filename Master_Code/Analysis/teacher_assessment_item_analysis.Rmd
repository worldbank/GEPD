...
p_sdi_lang <- ggplot(Assessment_math_scores[Assessment_math_scores$countrycode!="PAK",], aes(F1, color=countryname)) +
...
p_sdi_math <-ggplot(Assessment_lang_scores[Assessment_lang_scores$countrycode!="PAK",], aes(F1, color=countryname)) +
  geom_histogram(position="identity", binwidth=0.05, aes(y=..density.., fill=countryname),  alpha=0.25) +
  geom_density(size=1) +
  expand_limits(x=c(-3,3)) +
  #facet_wrap(~countryname, ncol=2)+
