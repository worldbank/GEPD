...
For teacher absenteeism, we were able to assess the absence of 1461 teachers in our sampled schools.  This produced a mean absenteeism rate of `r round(peru_stats$Mean[3],2)` and a standard error of `r round((as.numeric(substr(peru_stats$CI[3],str_length(peru_stats$CI[3])-5,str_length(peru_stats$CI[3])-1))-peru_stats$Mean[3])/1.96,2)`. Therefore the standard error for our two mean difference is just $\sqrt 2$ times this standard error.  Therefore, our standard error for our two mean difference will be `r round(2^(1/2)*(as.numeric(substr(peru_stats$CI[3],str_length(peru_stats$CI[3])-5,str_length(peru_stats$CI[3])-1))-peru_stats$Mean[3])/1.96,2)`

Finally, to determine our detectable effect, we will be able to reject the null of an identical mean for teacher absenteeism if our absenteeism measure in the second Peru survey exceeds plus or minus: `r round(1.96*2^(1/2)*(as.numeric(substr(peru_stats$CI[3],str_length(peru_stats$CI[3])-5,str_length(peru_stats$CI[3])-1))-peru_stats$Mean[3])/1.96,2)` percentage points from our original mean of `r round(peru_stats$Mean[3],2)` .

This actually suggests that in the case of Peru, our forecast of detectable effect sizes were too pessimistic, as we were expecting somewhere in the range of 6-8 percentage points.  This could be attributed to lower than typical intra-class correlations in Peru for absence or to improved precision resulting from our optimal stratification technique.

For teacher content knowledge, we will omit the same full exercise as with absence, but will only say that we will be able to reject the null of an identical mean for teacher content knowledge if our measure in the second Peru survey exceeds plus or minus: `r round(1.96*2^(1/2)*(as.numeric(substr(peru_stats$CI[4],str_length(peru_stats$CI[4])-5,str_length(peru_stats$CI[4])-1))-peru_stats$Mean[4])/1.96,2)` percentage points from our original mean.

For our Early Childhood assessment, can say that we will be able to reject the null of an identical mean for ECE if our measure in the second Peru survey exceeds plus or minus: `r round(1.96*2^(1/2)*(as.numeric(substr(peru_stats$CI[5],str_length(peru_stats$CI[5])-5,str_length(peru_stats$CI[5])-1))-peru_stats$Mean[5])/1.96,2)` percentage points from our original mean.
...
For teacher absenteeism, we were able to assess the absence of 1461 teachers in our sampled schools.  This produced a mean absenteeism rate of `r round(Jordan_stats$Mean[3],2)` and a standard error of `r round((as.numeric(substr(Jordan_stats$CI[3],str_length(Jordan_stats$CI[3])-5,str_length(Jordan_stats$CI[3])-1))-Jordan_stats$Mean[3])/1.96,2)`. Therefore the standard error for our two mean difference is just $\sqrt 2$ times this standard error.  Therefore, our standard error for our two mean difference will be `r round(2^(1/2)*(as.numeric(substr(Jordan_stats$CI[3],str_length(Jordan_stats$CI[3])-5,str_length(Jordan_stats$CI[3])-1))-Jordan_stats$Mean[3])/1.96,2)`

Finally, to determine our detectable effect, we will be able to reject the null of an identical mean for teacher absenteeism if our absenteeism measure in the second Jordan survey exceeds plus or minus: `r round(1.96*2^(1/2)*(as.numeric(substr(Jordan_stats$CI[3],str_length(Jordan_stats$CI[3])-5,str_length(Jordan_stats$CI[3])-1))-Jordan_stats$Mean[3])/1.96,2)` percentage points from our original mean of `r round(Jordan_stats$Mean[3],2)` .

This actually suggests that in the case of Jordan, our forecast of detectable effect sizes were too pessimistic, as we were expecting somewhere in the range of 6-8 percentage points.  This could be attributed to lower than typical intra-class correlations in Jordan for absence or to improved precision resulting from our optimal stratification technique.

For teacher content knowledge, we will omit the same full exercise as with absence, but will only say that we will be able to reject the null of an identical mean for teacher content knowledge if our measure in the second Jordan survey exceeds plus or minus: `r round(1.96*2^(1/2)*(as.numeric(substr(Jordan_stats$CI[4],str_length(Jordan_stats$CI[4])-5,str_length(Jordan_stats$CI[4])-1))-Jordan_stats$Mean[4])/1.96,2)` percentage points from our original mean.

For our Early Childhood assessment, can say that we will be able to reject the null of an identical mean for ECE if our measure in the second Jordan survey exceeds plus or minus: `r round(1.96*2^(1/2)*(as.numeric(substr(Jordan_stats$CI[5],str_length(Jordan_stats$CI[5])-5,str_length(Jordan_stats$CI[5])-1))-Jordan_stats$Mean[5])/1.96,2)` percentage points from our original mean.
...
For teacher absenteeism, we were able to assess the absence of 1461 teachers in our sampled schools.  This produced a mean absenteeism rate of `r round(Rwanda_stats$Mean[3],2)` and a standard error of `r round((as.numeric(substr(Rwanda_stats$CI[3],str_length(Rwanda_stats$CI[3])-5,str_length(Rwanda_stats$CI[3])-1))-Rwanda_stats$Mean[3])/1.96,2)`. Therefore the standard error for our two mean difference is just $\sqrt 2$ times this standard error.  Therefore, our standard error for our two mean difference will be `r round(2^(1/2)*(as.numeric(substr(Rwanda_stats$CI[3],str_length(Rwanda_stats$CI[3])-5,str_length(Rwanda_stats$CI[3])-1))-Rwanda_stats$Mean[3])/1.96,2)`

Finally, to determine our detectable effect, we will be able to reject the null of an identical mean for teacher absenteeism if our absenteeism measure in the second Rwanda survey exceeds plus or minus: `r round(1.96*2^(1/2)*(as.numeric(substr(Rwanda_stats$CI[3],str_length(Rwanda_stats$CI[3])-5,str_length(Rwanda_stats$CI[3])-1))-Rwanda_stats$Mean[3])/1.96,2)` percentage points from our original mean of `r round(Rwanda_stats$Mean[3],2)` .

This actually suggests that in the case of Rwanda, our forecast of detectable effect sizes were too pessimistic, as we were expecting somewhere in the range of 6-8 percentage points.  This could be attributed to lower than typical intra-class correlations in Rwanda for absence or to improved precision resulting from our optimal stratification technique.

For teacher content knowledge, we will omit the same full exercise as with absence, but will only say that we will be able to reject the null of an identical mean for teacher content knowledge if our measure in the second Rwanda survey exceeds plus or minus: `r round(1.96*2^(1/2)*(as.numeric(substr(Rwanda_stats$CI[4],str_length(Rwanda_stats$CI[4])-5,str_length(Rwanda_stats$CI[4])-1))-Rwanda_stats$Mean[4])/1.96,2)` percentage points from our original mean.

For our Early Childhood assessment, can say that we will be able to reject the null of an identical mean for ECE if our measure in the second Rwanda survey exceeds plus or minus: `r round(1.96*2^(1/2)*(as.numeric(substr(Rwanda_stats$CI[5],str_length(Rwanda_stats$CI[5])-5,str_length(Rwanda_stats$CI[5])-1))-Rwanda_stats$Mean[5])/1.96,2)` percentage points from our original mean.
