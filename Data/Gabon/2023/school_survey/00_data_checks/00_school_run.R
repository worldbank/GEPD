...
if (Sys.getenv("USERNAME") == "wb469649"){
  ...
  download_folder <-file.path(paste(project_folder,country_name,year,"Data/school_survey/rollout/raw", sep="/"))
  save_folder <- file.path(paste(project_folder,country_name,year,"Data/school_survey/rollout/clean", sep="/"))
  
  backup_onedrive="yes"
  save_folder_onedrive <- file.path(paste("C:/Users/wb577189/OneDrive - WBG/My files/Dashboard (Team Folder)/Country_Work/", country_name,year,"Data/school_survey/rollout", sep="/"))
