...
This file outlines the sampling strategy for Gabon.  We will draw a sample of 200 schools.  Only schools with at least 15 students and 3 teachers will be selected, which is consistent with the approach in Niger.  Strata will be based on province and public/private status.
...
strata_df <- df_updated %>%
  ...
  mutate(share_district=100*round(nstudents_district/sum(nstudents_district),3),
         sample_size=case_when(
           private==0 & Province=="ESTUAIRE" ~ 40,
           private==1 & Province=="ESTUAIRE" ~ 50,
        
           private==0 & Province=="HAUT-OGOOUE" ~ 15,
           private==1 & Province=="HAUT-OGOOUE" ~ 10,
           
           private==0 & Province=="MOYEN-OGOOUE" ~ 6,
           private==1 & Province=="MOYEN-OGOOUE" ~ 4,
           
           private==0 & Province=="NGOUNIE" ~ 8,
           private==1 & Province=="NGOUNIE" ~ 5,
           
           private==0 & Province=="NYANGA" ~ 4,
           private==1 & Province=="NYANGA" ~ 4,
           
           private==0 & Province=="OGOOUE-IVINDO" ~ 5,
           private==1 & Province=="OGOOUE-IVINDO" ~ 4,
           
           private==0 & Province=="OGOOUE-LOLO" ~ 4,
           private==1 & Province=="OGOOUE-LOLO" ~ 4,
           
           private==0 & Province=="OGOOUE-MARITIME" ~ 10,
           private==1 & Province=="OGOOUE-MARITIME" ~ 13,
           
           private==0 & Province=="WOLEU-NTEM" ~ 8,
           private==1 & Province=="WOLEU-NTEM" ~ 6
         ))
...
```{r country_map2, eval=FALSE, include=FALSE}
library(leaflet)
#unreliable data
