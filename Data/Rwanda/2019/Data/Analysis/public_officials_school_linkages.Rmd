...
patch_plot + plot_annotation(
  ...
  caption = 'Regional shading shows average of all public officials in that district including officials at Directorate level'
)
```
...
patch_scatter + plot_annotation(
  ...
  caption = str_wrap('Regional average of all public officials in that district including officials at Directorate level',150)
)
