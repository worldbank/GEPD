...
```{r missings, eval=FALSE, error=FALSE, fig.height=13, fig.width=8, message=FALSE, include=FALSE}
...
```{r missings2, eval=FALSE, include=FALSE}
...
```{r missings_kable, eval=FALSE, include=FALSE}
...
```{r map_guts, eval=FALSE, warning=FALSE, include=FALSE}
...
```{r map_plot, eval=FALSE, warning=FALSE, include=FALSE}
...
```{r orphans, eval=FALSE, warning=FALSE, include=FALSE}
