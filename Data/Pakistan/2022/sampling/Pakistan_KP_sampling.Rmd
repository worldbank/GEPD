...
strata_df_200 <- df_updated_gepd %>%
  ...
  mutate(share_district=100*round(nstudents_district/sum(nstudents_district),3),
         sample_size=case_when(
           ...
           Gender=="Co-Edu" & Location=="Urban" ~ 5,
...
sample_df_200 <- df_updated_gepd %>%
  ...
  sample_n(size = sample_size, weight =total_enrollment) %>%
  ungroup() %>%
...
strata_df_175 <- df_updated_gepd %>%
  ...
  mutate(share_district=100*round(nstudents_district/sum(nstudents_district),3),
         sample_size=case_when(
           ...
           Gender=="Co-Edu" & Location=="Urban" ~ 4,
