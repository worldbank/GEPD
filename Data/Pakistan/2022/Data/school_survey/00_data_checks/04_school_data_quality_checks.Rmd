...
save_folder <- 'C:/Users/wb577189/OneDrive - WBG/My files/Dashboard (Team Folder)/Country_Work/Pakistan_all/2021/Data/02. Provinces/ICT/clean/'

load(file=paste(save_folder, "school/paradata_light.RData", sep="/"))
```
...
load(paste(save_folder, "school/school_survey_data.RData", sep="/"))
...
#validate
# out <- confront(school_dta_short, CONT_rules)
# summary(out)
# plot(out)
```
...
#validate
out <- confront(teacher_assessment_dta, CONT_rules)
summary(out)
plot(out)
```
