...
assignments <- read.table( "C:/Users/wb577189/OneDrive - WBG/My files/Dashboard (Team Folder)/Country_Work/Pakistan_all/2021/Survey solutions/TEACH_ECE/01.ict/teach_assignment_pak_ict.txt", sep="\t", header=TRUE) %>% mutate(across(everything(), as.character)) %>% 
  bind_rows(read.table( "C:/Users/wb577189/OneDrive - WBG/My files/Dashboard (Team Folder)/Country_Work/Pakistan_all/2021/Survey solutions/TEACH_ECE/01.ict/teach_assignment_pak_ict_2.txt", sep="\t", header=TRUE) %>% mutate(across(everything(), as.character)))
