...
server_datasets <- 'https://api.dhsprogram.com/rest/dhs/datasets/PE'
...
#Get list of datsets
datasets_avail<-fromJSON(content(GET(paste(server_datasets, sep="")), as='text'))
datasets_avail_df<-datasets_avail$Data
#get dhs data
