...
r2s <- school_map %>%
  dplyr::select(-c('school_code', 'school_name_preload', 'school_address_preload',
                   'm1s0q2_emis', 'm1s0q2_code',
                   'school_province_preload', 'school_district_preload', 'school_code_preload',
                   'school_emis_preload', 'school_info_correct', 'm1s0q2_name', 
                   'lat', 'lon', 'survey_time', 'total_missing', 'missings', 'GDP')) %>% # just keep indicators for regression on GDP
