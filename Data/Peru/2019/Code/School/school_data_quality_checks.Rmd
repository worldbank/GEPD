...
frame_test <- school_dta_short %>%
  ...
  select(school_code, indicator_list, contains('enroll'))
...
stargazer( multi_reg, type = "html",
           se        = list(robust_multi_se),
           title = "Regression of Gap between Total Enrollment as Collected during School Survey and EMIS data on Dashboard Indicators",
           style='aer',
           notes= c(
                    'Heteroskedasticity robust standard errors in parenthesis.'
                    )
