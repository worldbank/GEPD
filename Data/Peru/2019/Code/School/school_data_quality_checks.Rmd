...
sumstats_df<-skim(sumstats) %>%
  ...
  mutate(variable=factor(variable, levels=c("student_knowledge", "absence_rate", "content_knowledge", "ecd_student_knowledge", "inputs", "infrastructure"),
                         labels=c("4th Grade Student Knowledge (Fraction Correct)", "Teacher Absence Rate", 
           "Teacher Content Knowledge", "1st Grade Assessment (Fraction Correct)", "Inputs", "Infrastructure")))
...
bscols(widths=c(3,NA),
  ...
  filter_checkbox("prov", "Province", linked_df_orphan, ~school_province_preload, inline=FALSE),
  filter_checkbox("reg", "District", linked_df_orphan, ~school_district_preload, inline=FALSE)
