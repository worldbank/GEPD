...
my_skim <- skim_with( numeric = sfl( complete_count= ~ sum(!is.na(.))))
...
kable(overall_time_comb, caption="Summary Statistics of Time Length of Interviews by Indicator" ,  col.names = c("Indicator", "Mean",  "Std Dev","Min", "25th Percentile", "Median", "75th Percentile", "Max", "# Complete Cases", "# Missing Cases", "Histogram"), digits = 2 ) %>%
  kable_styling()
...
kable(sumstats_df, caption="Summary Statistics of Key Indicator Variables" , col.names = c("Indicator", "Mean",  "Std Dev","Min", "25th Percentile", "Median", "75th Percentile", "Max", "# Complete Cases", "# Missing Cases", "Histogram"), digits = 2 ) %>%
  kable_styling()
...
bscols(widths=c(3,NA),
  ...
  filter_select("prov", "Province", linked_df, ~province),
  filter_select("dist", "District", linked_df, ~district),
