...
para_df<-read.delim("C:/Users/wb577189/OneDrive - WBG/My files/Dashboard (Team Folder)/Country_Work/Sierra Leone/2021/Data/raw/Public_Officials/paradata.tab", sep="\t") 
