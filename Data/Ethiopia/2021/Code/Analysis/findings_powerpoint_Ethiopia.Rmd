---
title: "Global Education Policy Dashboard - Ethiopia 2021"
...
Roadmap:  
- Below is a set of tables and charts containing findings for the Ethiopia 2021 Global Education Policy Dashboard survey. - We will start with breakdowns of our Practice indicators  
...
#set directory to bring in data
 ...
 if(Sys.info()["user"] == "wb577189"){
    ...
    work_dir<- "C:/Users/wb577189/OneDrive - WBG/GEPD-Confidential/CNT/ETH/ETH_2021_GEPD/ETH_2021_GEPD_v01_RAW/Data/anonymized/"
...
# School Survey
  ...
  sumstats_df %>%
    ...
    kable(caption = "Summary Statistics of Dashboard Indicators - Ethiopia 2021 - Urban/Rural",
...
#public/private
  ...
  sumstats_df %>%
    ...
    kable(caption = "Summary Statistics of Dashboard Indicators - Ethiopia 2021 - Public/Private Schools",
          col.names = c("Indicator", "Mean", "95% Confident Interval", "Mean", "95% Confident Interval"
...
# test <- data_radar %>% 
#   pivot_longer(cols = teacher_attraction:principal_evaluation,
#                names_to = "Indicator",
#                values_to = "Value") %>% 
#   group_by(group) %>% 
...
data_plot <- school_dta_short_anon %>%
  select(hashed_school_code,  indicators_list) %>%
  pivot_longer(cols=c("teacher_attraction", "teacher_selection_deployment", "teacher_support", "teaching_evaluation",
                      "teacher_monitoring","sch_management_attraction", "sch_selection_deployment", "sch_support", "principal_evaluation"),
               names_to = "indicators",
               values_to = "indicator_values") 

dataMedian <- summarise(group_by(data_plot, indicators), MD = round(median(indicator_values, na.rm=T),1))
...
```{r dejure_defacto_gap, eval=FALSE, include=T}
