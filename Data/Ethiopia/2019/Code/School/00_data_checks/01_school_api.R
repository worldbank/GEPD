...
POST(paste(server_add,"/api/v1/export/stata/f09adb3305a440bca53462755afc4fa7$",quest_version,"/start", sep=""),
         authenticate(user, password))

#sleep for 10 seconds to wait for stata file to compile
Sys.sleep(10)

dataDownload <- GET(paste(server_add,"/api/v1/export/stata/f09adb3305a440bca53462755afc4fa7$", quest_version,"/",sep=""),
                    authenticate(user, password))
